...
export const metadata: Metadata = {
  title: 'Immobilienmakler Bad Camberg – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Bad Camberg & Landkreis Limburg-Weilburg. Professioneller Immobilienverkauf mit marktgerechter Bewertung, persönlicher Betreuung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Bad Camberg, Immobilien Bad Camberg, Haus verkaufen Bad Camberg, Wohnung verkaufen Bad Camberg, Landkreis Limburg-Weilburg Immobilien, Immobilienbewertung Bad Camberg, Taunus Immobilien',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-bad-camberg' },
  openGraph: {
    title: 'Immobilienmakler Bad Camberg – immovativInvest',
    description: 'Ihre Immobilie in Bad Camberg professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-bad-camberg',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Bad Camberg',
    description: 'Wir kennen den Immobilienmarkt in Bad Camberg und dem Landkreis Limburg-Weilburg genau – Preise, Nachfrage und die Besonderheiten der idyllischen Kurstadt am Taunusrand.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Bad Camberg und dem gesamten Taunus-Vorland.',
  },
  {
    icon: '📣',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Bad Camberg und deine Ziele kennen.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir erstellen eine fundierte Marktpreisanalyse für Bad Camberg und legen gemeinsam den optimalen Verkaufspreis fest.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerBadCambergPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Bad Camberg" slug="bad-camberg" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Bad Camberg</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-6">
                Immobilienmakler
                <span className="text-brand-green"> Bad Camberg.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-8">
                Dein Immobilienexperte für Bad Camberg und den Landkreis Limburg-Weilburg. Wir vermarkten deine Immobilie professionell in der idyllischen Kurstadt am Taunusrand und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Lokale Expertise im Landkreis Limburg-Weilburg',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image
                  ...
                  alt="Niclas van der Straeten – Immobilienmakler Bad Camberg"
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Bad Camberg</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mt-5">Ich kenne Bad Camberg als eine der ruhigsten und dabei am meisten unterschätzten Lagen im Limburger Becken. Die Nähe zum Taunus, gute Anbindung nach Frankfurt und Limburg – das zieht vor allem Familien an, die Platz wollen, ohne tief in die Tasche zu greifen.</p>
                <p className="text-gray-600 text-sm leading-relaxed mt-3">In Bad Camberg bekommst du für dein Geld noch echte Einfamilienhäuser mit Garten. Das ist ein Verkaufsargument, das ich gezielt bei Käufern aus dem Rhein-Main-Gebiet einsetze – denn die suchen genau das.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Bad Camberg
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Bad Camberg – <span className="text-brand-green">Idyllische Kurstadt am Taunusrand mit stabiler Nachfrage.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Bad Camberg liegt im westlichen Taunus und vereint Kurort-Qualität mit ländlicher Ruhe und guter Verkehrsanbindung. Die Nähe zur A3 macht die Stadt besonders für Pendler attraktiv, die das Leben abseits der Großstadt genießen möchten – ohne auf kurze Wege nach Frankfurt oder Wiesbaden verzichten zu müssen.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die typische Käufernachfrage, die Preisunterschiede zwischen den Stadtteilen und die aktuellen Markttrends – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg in Bad Camberg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '430.000 €', sub: 'Einfamilienhaus Bad Camberg' },
                  { label: 'Ø m²-Preis', value: '3.000 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '45 km', sub: 'A3' },
                  { label: 'Einwohner', value: '~13.000', sub: 'Stadt Bad Camberg' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image
                ...
                alt="Immobilien Bad Camberg Taunus"
        ...
        <div className="container-max">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Bad Camberg.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Bad Camberg.
            </p>
          </div>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Bad Camberg"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Bad Camberg verkaufen?
              </h2>
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
            deine Immobilie in Bad Camberg. Unser Einsatz. Ihr Erfolg.
          </h2>
      ...
      <NearbyStaedte currentSlug="bad-camberg" />
