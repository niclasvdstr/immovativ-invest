...
const benefits = [
  {
    ...
    description: 'Wir kennen Gravenbruch, Kernstadt und Zeppelinheim und wissen, welche Lagen für Käufer besonders attraktiv sind.',
  },
  {
    icon: '🏙️',
    title: 'Frankfurter Stadtrand',
    description: 'Die direkte Nähe zu Frankfurt macht Neu-Isenburg für Käufer interessant, die die Stadtqualität ohne Frankfurter Preise suchen.',
  },
  {
    icon: '📊',
    title: 'Starke Preisentwicklung',
    description: 'Neu-Isenburg verzeichnet kontinuierlich steigende Nachfrage durch Käufer aus Frankfurt. Verkäufer profitieren von diesem Trend.',
  },
  {
    icon: '🤝',
    title: 'Käufernetzwerk Frankfurt/Offenbach',
    description: 'Wir sprechen gezielt kaufkräftige Interessenten aus Frankfurt und dem Rhein-Main-Gebiet an.',
  },
  {
    icon: '📸',
    title: 'Professionelle Vermarktung',
    description: 'Hochwertige Fotos, ansprechende Exposés und gezielte Online-Präsenz für deine Immobilie.',
  },
  {
    icon: '🔑',
...
const processSteps = [
  {
    ...
    description: 'Wir lernen deine Immobilie in Neu-Isenburg kennen.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Neu-Isenburg und dem Landkreis Offenbach.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Exklusive Vermarktung',
    description: 'Gezielte Ansprache kaufkräftiger Interessenten aus Frankfurt und dem Rhein-Main-Gebiet.',
  },
  {
    number: 4,
    icon: '🏆',
    title: 'Verkauf zum Toppreis',
    description: 'Wir verhandeln und begleiten bis zur Vertragsunterzeichnung.',
  },
]

const stadtteilPreise = [
  { name: 'Gravenbruch', preis: '6.000–9.000 €/m²', beschreibung: 'Exklusives Villenviertel, sehr begehrt' },
  { name: 'Kernstadt', preis: '4.500–6.500 €/m²', beschreibung: 'Zentrum, beste Infrastruktur' },
...
export default function ImmobilienmaklerNeuIsenburgPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Neu-Isenburg" slug="neu-isenburg" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Neu-Isenburg</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Neu-Isenburg.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Direkt südlich von Frankfurt – mit hervorragender Infrastruktur und starker Nachfrage.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Neu-Isenburg und den Landkreis Offenbach. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Lokale Expertise in Neu-Isenburg und Umgebung',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Neu-Isenburg" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Neu-Isenburg</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Neu-Isenburg liegt unmittelbar südlich von Frankfurt und gehört zu den begehrtesten Wohnlagen im Landkreis Offenbach. Die Stadtgrenznähe, hervorragende Anbindung über Straße und ÖPNV sowie eine gute Infrastruktur machen Neu-Isenburg für Pendler und Familien besonders attraktiv.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als Immobilienmakler kennen wir den Neu-Isenburger Markt genau – von der belebten Kernstadt über das exklusive Gravenbruch bis zum Flughafennahen Zeppelinheim.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Einwohner', value: '~38.000', sub: 'Stadt Neu-Isenburg' },
                  { label: 'Ø Hauspreis', value: '550.000 €', sub: 'Einfamilienhaus' },
                  { label: 'Ø m²-Preis', value: '5.000 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '8 km', sub: 'A3 / S-Bahn' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&h=600&fit=crop" alt="Immobilien Neu-Isenburg Landkreis Offenbach" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              Stadtteile & Preise in <span className="text-brand-green">Neu-Isenburg</span>
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Aktuelle Marktpreise nach Neu-Isenburger Stadtteilen – als Orientierung für deinen Verkauf.
            </p>
          </div>
      ...
      <section id="vorteile" className="section-padding bg-white">
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Neu-Isenburg.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Neu-Isenburg.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Neu-Isenburg"
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                <div className="inline-flex items-center gap-2 bg-brand-green text-white rounded-full px-4 py-1.5 text-sm font-semibold mb-4">
                  💡 Niclas-Tipp für Neu-Isenburg
                </div>
                <p className="text-brand-anthrazit text-lg leading-relaxed mb-4">
                  "Neu-Isenburg ist der perfekte Kompromiss für Käufer, die Frankfurt lieben, aber mehr Platz und Ruhe suchen. Diesen Vorteil nutze ich gezielt in der Vermarktung – deine Immobilie erreicht genau die richtigen Käufer."
                </p>
      ...
      <section className="section-padding bg-brand-gray-light">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Neu-Isenburg verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Neu-Isenburg" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
  ...
  Immobilienbewertung starten →
      ...
      <NearbyStaedte currentSlug="neu-isenburg" />
