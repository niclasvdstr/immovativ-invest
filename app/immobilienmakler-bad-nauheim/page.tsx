...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Immobilienmakler Bad Nauheim – immovativInvest',
    description: 'Ihre Immobilie in Bad Nauheim professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-bad-nauheim',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Bad Nauheim',
    description: 'Wir kennen den Immobilienmarkt in Bad Nauheim und dem Wetteraukreis genau – Preise, Nachfrage und die besonderen Qualitäten der beliebten Kurstadt nahe Frankfurt.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Bad Nauheim und der gesamten Rhein-Main-Region.',
  },
  {
    icon: '📣',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Bad Nauheim und deine Ziele kennen.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir erstellen eine fundierte Marktpreisanalyse für Bad Nauheim und legen gemeinsam den optimalen Verkaufspreis fest.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerBadNauheimPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Bad Nauheim" slug="bad-nauheim" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Bad Nauheim</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-6">
                Immobilienmakler
                <span className="text-brand-green"> Bad Nauheim.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-8">
                Dein Immobilienexperte für Bad Nauheim und den Wetteraukreis. Wir vermarkten deine Immobilie professionell in der beliebten Kurstadt nahe Frankfurt und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image
                  ...
                  alt="Niclas van der Straeten – Immobilienmakler Bad Nauheim"
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Bad Nauheim</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mt-5">Bad Nauheim ist mehr als eine Kurstadt – es ist ein stabiler Immobilienmarkt mit konstantem Zuzug, auch weil die Preise gegenüber Bad Homburg oder Bad Soden noch moderat sind. Das macht es für Käufer interessant, die Taunus-Nähe suchen, aber nicht Taunus-Preise zahlen wollen.</p>
                <p className="text-gray-600 text-sm leading-relaxed mt-3">Die Anbindung über die A5 und die Nähe zum Flughafen Frankfurt machen Bad Nauheim besonders für Käufer mit internationalem Lebensstil attraktiv. Dieses Argument nutze ich aktiv in der Vermarktung.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„Bad Nauheim wird von vielen Käufern als &apos;günstigere Alternative&apos; zu Bad Homburg gesehen – was es für Verkäufer zu einem sehr guten Moment macht."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Gefragt sind vor allem ruhige Wohnlagen nahe dem Kurpark und gut angebundene Einfamilienhäuser. Die Nachfrage übersteigt das Angebot, was für Verkäufer kurze Vermarktungszeiten bedeutet.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Bad Nauheim – <span className="text-brand-green">Beliebte Kurstadt mit hoher Lebensqualität nahe Frankfurt.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Bad Nauheim verbindet das Flair einer traditionsreichen Kurstadt mit hervorragender Anbindung an die Rhein-Main-Region. Das einzigartige Jugendstilensemble, die gepflegten Parkanlagen und das ruhige Stadtbild machen Bad Nauheim zu einem der begehrtesten Wohnstandorte im Wetteraukreis.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die typische Käufernachfrage, die Preisunterschiede zwischen den Stadtteilen und die aktuellen Markttrends – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg in Bad Nauheim.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '520.000 €', sub: 'Einfamilienhaus Bad Nauheim' },
                  { label: 'Ø m²-Preis', value: '3.500 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '35 km', sub: 'A5' },
                  { label: 'Einwohner', value: '~32.000', sub: 'Stadt Bad Nauheim' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image
                ...
                alt="Immobilien Bad Nauheim Wetteraukreis"
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Bad Nauheim"
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
            deine Immobilie in Bad Nauheim. Unser Einsatz. Ihr Erfolg.
          </h2>
      ...
      <NearbyStaedte currentSlug="bad-nauheim" />
