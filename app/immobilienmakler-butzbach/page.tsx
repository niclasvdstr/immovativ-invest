...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Immobilienmakler Butzbach – immovativInvest',
    description: 'Ihre Immobilie in Butzbach professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-butzbach',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Butzbach',
    description: 'Wir kennen den Immobilienmarkt in Butzbach und dem Wetteraukreis genau – Preise, Nachfrage und die Besonderheiten der charmanten Fachwerkstadt in der Wetterau.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Butzbach und der gesamten Wetterauregion.',
  },
  {
    icon: '📣',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Butzbach und deine Ziele kennen.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir erstellen eine fundierte Marktpreisanalyse für Butzbach und legen gemeinsam den optimalen Verkaufspreis fest.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerButzbachPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Butzbach" slug="butzbach" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Butzbach</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-6">
                Immobilienmakler
                <span className="text-brand-green"> Butzbach.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-8">
                Dein Immobilienexperte für Butzbach und den Wetteraukreis. Wir vermarkten deine Immobilie professionell in der charmanten Fachwerkstadt in der Wetterau und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image
                  ...
                  alt="Niclas van der Straeten – Immobilienmakler Butzbach"
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Butzbach</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mt-5">Butzbach liegt im Herzen der Wetterau – und das ist ein echter Standortvorteil für Pendler Richtung Frankfurt und Gießen. Die Stadt hat ein stabiles, bodenständiges Preisniveau, das Käufer anspricht, die echten Gegenwert für ihr Geld suchen.</p>
                <p className="text-gray-600 text-sm leading-relaxed mt-3">In Butzbach findet man noch Immobilien, bei denen der Kaufpreis und die Quadratmeter noch in einem vernünftigen Verhältnis stehen. Ich vermarkte das aktiv an Käufer, die aus teureren Märkten abgewandert sind und frischen Wind suchen.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Butzbach
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Butzbach – <span className="text-brand-green">Charmante Fachwerkstadt in der Wetterau mit guter Frankfurt-Anbindung.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Butzbach liegt im nördlichen Wetteraukreis und besticht durch seinen historischen Fachwerkkern, die ruhige Wetterau-Landschaft und die hervorragende Anbindung an die A5 Richtung Frankfurt. Die Stadt ist besonders bei Familien beliebt, die das Landleben genießen und dennoch pendlerfreundliche Wege in die Metropole benötigen.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die typische Käufernachfrage, die Preisunterschiede zwischen den Stadtteilen und die aktuellen Markttrends – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg in Butzbach.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '450.000 €', sub: 'Einfamilienhaus Butzbach' },
                  { label: 'Ø m²-Preis', value: '3.200 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '45 km', sub: 'A5' },
                  { label: 'Einwohner', value: '~25.000', sub: 'Stadt Butzbach' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image
                ...
                alt="Immobilien Butzbach Wetteraukreis"
        ...
        <div className="container-max">
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Butzbach.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Butzbach.
            </p>
          </div>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Butzbach"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Butzbach verkaufen?
              </h2>
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-left md:text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
            deine Immobilie in Butzbach. Unser Einsatz. Ihr Erfolg.
          </h2>
      ...
      <NearbyStaedte currentSlug="butzbach" />
