...
export const metadata: Metadata = {
  title: 'Immobilienmakler Friedrichsdorf – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Friedrichsdorf im Hochtaunuskreis. Professioneller Immobilienverkauf mit marktgerechter Bewertung, persönlicher Betreuung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Friedrichsdorf, Immobilien Friedrichsdorf, Haus verkaufen Friedrichsdorf, Wohnung verkaufen Friedrichsdorf, Hochtaunuskreis Immobilien, Immobilienbewertung Friedrichsdorf, Taunus Immobilien',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-friedrichsdorf' },
  openGraph: {
    title: 'Immobilienmakler Friedrichsdorf – immovativInvest',
    description: 'Ihre Immobilie in Friedrichsdorf professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-friedrichsdorf',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Friedrichsdorf',
    description: 'Wir kennen den Immobilienmarkt in Friedrichsdorf genau – von Köppern und Seulberg bis Burgholzhausen und Dillingen.',
  },
  {
    icon: '🚂',
    title: 'Lageexpertise Taunus & Bahn',
    description: 'Die hervorragende Bahnanbindung nach Frankfurt macht Friedrichsdorf besonders attraktiv für Pendler – ein starkes Verkaufsargument, das wir gezielt einsetzen.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Friedrichsdorf und dem gesamten Hochtaunuskreis.',
  },
  {
    icon: '⏱️',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Friedrichsdorf kennen – ob Einfamilienhaus in Seulberg, Reihenhaus in Burgholzhausen oder Wohnung in Köppern.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir erstellen eine fundierte Marktpreisanalyse für Friedrichsdorf und legen gemeinsam den optimalen Verkaufspreis fest.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Vermarktungsstrategie',
    description: 'Professionelle Präsentation, gezielte Vermarktung an Frankfurter Pendler und Taunusliebhaber sowie qualifizierte Besichtigungen.',
  },
  {
    number: 4,
    icon: '🏆',
    title: 'Verkauf zum besten Preis',
    description: 'Wir verhandeln für dich und begleiten dich bis zur erfolgreichen Vertragsunterzeichnung beim Notar.',
  },
]
...
export default function ImmobilienmaklerFriedrichsdorfPage() {
  return (
    <>
    <CityJsonLd cityName="Friedrichsdorf" slug="friedrichsdorf" />
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Friedrichsdorf</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Friedrichsdorf.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Beliebte Taunusgemeinde mit exzellenter Frankfurt-Anbindung.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Friedrichsdorf und den Hochtaunuskreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Friedrichsdorf" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Friedrichsdorf</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„Friedrichsdorf ist der kleine Bruder von Bad Homburg – ruhiger, grüner, günstiger. Für Käufer ein Schnäppchen, für Verkäufer ein überzeugtes Käuferpublikum."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Köppern und Seulberg sind die begehrtesten Ortsteile – ruhige Wohnlagen mit direktem Taunuszugang. Die S-Bahn-Verbindung nach Frankfurt und Bad Homburg macht Friedrichsdorf für Pendler ideal. Einfamilienhäuser mit Garten sind am stärksten nachgefragt.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Friedrichsdorf
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Friedrichsdorf – Taunusgemeinde<br />
                <span className="text-brand-green">mit direkter Frankfurt-Anbindung.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Friedrichsdorf liegt im Hochtaunuskreis, nur 22 km von Frankfurt entfernt (A661), und verbindet Taunusnatur mit hervorragender Infrastruktur. Die gut ausgebaute Bahnverbindung macht die Gemeinde besonders bei Pendlern beliebt – ein dauerhafter Nachfragetreiber für den Immobilienmarkt.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Preisunterschiede zwischen den Stadtteilen Köppern, Seulberg, Burgholzhausen und Dillingen sowie die aktuellen Markttrends – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '680.000 €', sub: 'Einfamilienhaus Friedrichsdorf' },
                  { label: 'Ø m²-Preis', value: '4.500 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '22 km', sub: 'A661' },
                  { label: 'Einwohner', value: '~25.000', sub: 'Stadt Friedrichsdorf' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop" alt="Immobilien Friedrichsdorf Hochtaunuskreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Friedrichsdorf.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Friedrichsdorf.
            </p>
          </div>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Friedrichsdorf"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Friedrichsdorf verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Friedrichsdorf" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-left md:text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">deine Immobilie in Friedrichsdorf. Unser Einsatz. Ihr Erfolg.</h2>
      ...
      <NearbyStaedte currentSlug="friedrichsdorf" />
