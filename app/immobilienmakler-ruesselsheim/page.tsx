...
export const metadata: Metadata = {
  title: 'Immobilienmakler Rüsselsheim am Main – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Rüsselsheim am Main im Kreis Groß-Gerau. Professioneller Verkauf von Immobilien in der aufstrebenden Mainstadt nahe dem Flughafen – marktgerechte Bewertung, persönliche Betreuung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Rüsselsheim, Immobilien Rüsselsheim am Main, Haus verkaufen Rüsselsheim, Wohnung verkaufen Rüsselsheim, Kreis Groß-Gerau Immobilien, Immobilienbewertung Rüsselsheim, Königstädten Bauschheim Immobilien',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-ruesselsheim' },
  openGraph: {
    title: 'Immobilienmakler Rüsselsheim am Main – immovativInvest',
    description: 'Ihre Immobilie in Rüsselsheim professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-ruesselsheim',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Rüsselsheim',
    description: 'Wir kennen den Immobilienmarkt in Rüsselsheim genau – von Königstädten und Bauschheim bis nach Haßloch und Cronsheim.',
  },
  {
    icon: '✈️',
    title: 'Flughafen-Nähe als Verkaufsargument',
    description: 'Rüsselsheims Nähe zum Frankfurter Flughafen macht die Stadt besonders für internationale Käufer und Flughafenangestellte attraktiv. Wir nutzen diesen Vorteil gezielt.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Rüsselsheim – mit einem Ø m²-Preis von 3.300 € kennen wir jede Marktfacette.',
  },
  {
    icon: '⏱️',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Rüsselsheim kennen – ob Einfamilienhaus in Königstädten, Wohnung in der Innenstadt oder Reihenhaus in Bauschheim.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Rüsselsheim und dem Kreis Groß-Gerau.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerRuesselsheimPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Rüsselsheim" slug="ruesselsheim" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Rüsselsheim</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Rüsselsheim.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Aufstrebende Mainstadt mit günstigem Einstieg nahe dem Flughafen.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Rüsselsheim am Main und den Kreis Groß-Gerau. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Lokale Expertise im Kreis Groß-Gerau',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Rüsselsheim" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Rüsselsheim</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Rüsselsheim
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Rüsselsheim – Aufstrebende Mainstadt<br />
                <span className="text-brand-green">mit günstigem Einstieg nahe dem Flughafen.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Rüsselsheim am Main ist mit rund 67.000 Einwohnern eine der größten Städte im Kreis Groß-Gerau. Die Mainlage, die Nähe zum Frankfurter Flughafen (ca. 10 km) und die gute S9-Verbindung nach Frankfurt machen die Stadt zu einem attraktiven Standort für Pendler und internationale Fachkräfte.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Unterschiede zwischen den Stadtteilen, die Nachfragepotenziale und die aktuellen Preisentwicklungen – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '430.000 €', sub: 'Einfamilienhaus Rüsselsheim' },
                  { label: 'Ø m²-Preis', value: '3.300 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '25 km', sub: 'A67 / S9' },
                  { label: 'Einwohner', value: '~67.000', sub: 'Stadt Rüsselsheim' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?w=800&h=600&fit=crop" alt="Immobilien Rüsselsheim am Main" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Rüsselsheim"
  ...
  Immobilienbewertung starten →
      ...
      <NearbyStaedte currentSlug="ruesselsheim" />
