...
export const metadata: Metadata = {
  title: 'Immobilienmakler Wiesbaden – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Wiesbaden. Professioneller Verkauf von Immobilien in Hessens Landeshauptstadt am Rhein – marktgerechte Bewertung, persönliche Betreuung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Wiesbaden, Immobilien Wiesbaden, Haus verkaufen Wiesbaden, Wohnung verkaufen Wiesbaden, Immobilienbewertung Wiesbaden, Makler Wiesbaden Biebrich, Makler Wiesbaden Sonnenberg',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-wiesbaden' },
  openGraph: {
    title: 'Immobilienmakler Wiesbaden – immovativInvest',
    description: 'Ihre Immobilie in Wiesbaden professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-wiesbaden',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Wiesbaden',
    description: 'Wir kennen Biebrich, Nordenstadt, Bierstadt, Sonnenberg und Dotzheim in ihrer Eigenheit und wissen, welche Lagen bei Käufern in Wiesbaden besonders gefragt sind.',
  },
  {
    icon: '🏛️',
    title: 'Exklusive Lagen und Villenviertel',
    description: 'Wiesbaden ist bekannt für seine repräsentativen Gründerzeitviertel und Villenlagen. Wir verfügen über das Netzwerk und die Diskretion, die für diese Objekte erforderlich sind.',
  },
  {
    icon: '💎',
    title: 'Landeshauptstadt mit Premiummarkt',
    description: 'Als Landeshauptstadt Hessens mit Rheingau, Kuranlage und internationalem Flair erzielt Wiesbaden überdurchschnittliche Immobilienpreise. Wir holen das Maximum für dich heraus.',
  },
  {
    icon: '🤝',
    title: 'Starkes Käufernetzwerk',
    description: 'Unser Netzwerk umfasst Kaufinteressenten aus Frankfurt, Mainz und dem gesamten Rhein-Main-Gebiet sowie internationale Käufer, die Wiesbaden als Premiumstandort schätzen.',
  },
  {
    icon: '📸',
    title: 'Professionelle Vermarktung',
    description: 'Erstklassige Fotos, anspruchsvolle Exposés und eine zielgerichtete Vermarktung – für Immobilien, die den hohen Ansprüchen des Wiesbadener Markts gerecht werden.',
  },
  {
    icon: '🔑',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Wiesbaden kennen – ob Stadtvilla im Nerotal oder Eigentumswohnung in Biebrich.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Wiesbaden und dem Rhein-Main-Gebiet.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Exklusive Vermarktung',
    description: 'Professionelle Präsentation, gezielte Ansprache qualifizierter Kaufinteressenten aus Frankfurt und Mainz sowie diskrete Besichtigungen.',
  },
  {
    number: 4,
    icon: '🏆',
...
const stadtteilPreise = [
  ...
  { name: 'Sonnenberg', preis: '6.000–10.000 €/m²', beschreibung: 'Begehrte Höhenlage mit Panoramablick' },
  { name: 'Bierstadt', preis: '4.500–6.000 €/m²', beschreibung: 'Beliebt bei Familien, gute Schulen' },
  { name: 'Biebrich', preis: '4.500–6.500 €/m²', beschreibung: 'Rheinufer, Schloss, hohe Nachfrage' },
  { name: 'Dotzheim', preis: '4.000–5.500 €/m²', beschreibung: 'Größter Stadtteil, vielfältige Lagen' },
  { name: 'Nordenstadt', preis: '4.000–5.500 €/m²', beschreibung: 'Familienfreundlich, ruhige Wohnlage' },
]

const niclasText = 'Wiesbaden hat einen besonderen Markt – hier treffen historischer Charme, exklusive Villenviertel und internationale Käufer aufeinander. Diskrete Vermarktung und ein hochwertiges Exposé sind in dieser Preisklasse unverzichtbar. Ich kenne diese Käufer und spreche sie gezielt an.'
...
export default function ImmobilienmaklerWiesbadenPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Wiesbaden" slug="wiesbaden" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Wiesbaden</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Wiesbaden.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Hessens Landeshauptstadt mit exklusiver Lage am Rhein.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Wiesbaden und das Rhein-Main-Gebiet. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Lokale Expertise in Wiesbaden und Umgebung',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Wiesbaden" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Wiesbaden</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Wiesbaden – Hessens Landeshauptstadt<br />
                <span className="text-brand-green">mit exklusivem Immobilienmarkt.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Wiesbaden ist eine der attraktivsten Städte Deutschlands – mit einzigartiger Architektur, exklusiven Villenvierteln, dem berühmten Kurpark und einer Lage direkt am Rhein. Die Landeshauptstadt zieht gut situierte Käufer aus dem gesamten Rhein-Main-Gebiet an.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Besonderheiten des Wiesbadener Premiummarkts – von der diskreten Vermarktung einer Villa im Nerotal bis zur zügigen Vermittlung einer Gründerzeitwohnung in der Innenstadt.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '680.000 €', sub: 'Einfamilienhaus Wiesbaden' },
                  { label: 'Ø m²-Preis', value: '5.200 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '40 km', sub: 'A66 / S-Bahn' },
                  { label: 'Einwohner', value: '285.000', sub: 'Landeshauptstadt' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&h=600&fit=crop" alt="Immobilien Wiesbaden Landeshauptstadt" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Wiesbaden.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Wiesbaden.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Wiesbaden"
          ...
          <div className="bg-brand-gray-light border-l-4 border-brand-green rounded-2xl p-8 max-w-3xl mx-auto">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <div className="text-xs text-brand-gray-warm">Dein Immobilienmakler in Wiesbaden</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Wiesbaden verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Wiesbaden" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
  ...
  Immobilienbewertung starten →
      ...
      <NearbyStaedte currentSlug="wiesbaden" />
