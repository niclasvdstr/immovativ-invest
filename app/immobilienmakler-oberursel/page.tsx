...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Immobilienmakler Oberursel (Taunus) – immovativInvest',
    description: 'Ihre Immobilie in Oberursel professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-oberursel',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Oberursel',
    description: 'Wir kennen den Immobilienmarkt in Oberursel genau – von Stierstadt und Bommersheim bis Weißkirchen, Oberstedten und der Nassauer Straße.',
  },
  {
    icon: '🚇',
    title: 'U-Bahn-Anbindung als Top-Argument',
    description: 'Die direkte U3-Verbindung nach Frankfurt macht Oberursel zu einem der gefragtesten Wohnstandorte im Taunus – ein Verkaufsargument, das wir gezielt nutzen.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Oberursel und dem gesamten Hochtaunuskreis.',
  },
  {
    icon: '⏱️',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Oberursel kennen – ob Villa in Stierstadt, Wohnung in Weißkirchen oder Reihenhaus in Bommersheim.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir erstellen eine fundierte Marktpreisanalyse für Oberursel unter Berücksichtigung der U-Bahn-Nähe und Stadtteilunterschiede.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Vermarktungsstrategie',
    description: 'Professionelle Präsentation, gezielte Ansprache von Frankfurter Käufern und Taunusliebhabern sowie qualifizierte Besichtigungen.',
  },
  {
    number: 4,
    icon: '🏆',
    title: 'Verkauf zum besten Preis',
    description: 'Wir verhandeln für dich und begleiten dich bis zur erfolgreichen Vertragsunterzeichnung – persönlich und professionell.',
  },
]
...
const stadtteilPreise = [
  ...
  { name: 'Stierstadt', preis: '5.000–7.000 €/m²', beschreibung: 'Ruhige Wohnlage, Taunus-Nähe' },
  { name: 'Weißkirchen', preis: '5.000–6.500 €/m²', beschreibung: 'Familienfreundlich, grüne Lage' },
  { name: 'Bommersheim', preis: '4.500–6.000 €/m²', beschreibung: 'Dörflicher Charakter, ruhig' },
  { name: 'Oberstedten', preis: '5.000–7.000 €/m²', beschreibung: 'Direkt an Bad Homburg, begehrt' },
]
...
export default function ImmobilienmaklerOberurselPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Oberursel" slug="oberursel" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Oberursel.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Begehrte Taunusstadt mit direkter U-Bahn-Anbindung nach Frankfurt.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Oberursel (Taunus) und den Hochtaunuskreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Oberursel" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Oberursel</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„Oberursel liegt preislich zwischen Frankfurt und Bad Homburg – und genau dort liegt auch die Kaufbereitschaft der Interessenten. Wer richtig bewertet, verkauft hier sehr gut."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Besonders gefragt: Einfamilienhäuser in Oberursel-Mitte und Bommersheim, Taunusnähe. Die U3 macht Oberursel für Frankfurt-Berufstätige ideal. Objekte in Schulnähe erzielen Aufschläge bei Familien mit Kindern.</p>
          </div>
          </AnimateIn>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Oberursel
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Oberursel – Taunusstadt<br />
                <span className="text-brand-green">mit direkter U-Bahn nach Frankfurt.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Oberursel (Taunus) liegt nur 12 km von Frankfurt entfernt und ist per U3 direkt mit der Innenstadt verbunden. Diese einzigartige Kombination aus Taunusnatur und urbanem Komfort macht Oberursel zu einem der begehrtesten Wohnstandorte im gesamten Rhein-Main-Gebiet.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Nachfrage und Preisunterschiede zwischen den Stadtteilen Stierstadt, Bommersheim, Weißkirchen, Oberstedten und der Innenstadt – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '780.000 €', sub: 'Einfamilienhaus Oberursel' },
                  { label: 'Ø m²-Preis', value: '5.200 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '12 km', sub: 'U3 / A661' },
                  { label: 'Einwohner', value: '~45.000', sub: 'Stadt Oberursel' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop" alt="Immobilien Oberursel Hochtaunuskreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
              <div className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-medium border border-brand-gray-border px-5 py-4">
                <div className="text-2xl font-bold text-brand-green">+21%</div>
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-10">
            <h2 className="text-3xl font-bold text-brand-anthrazit mb-3">
              Immobilienpreise nach <span className="text-brand-green">Stadtteil in Oberursel.</span>
            </h2>
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Oberursel.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Oberursel.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Oberursel"
          ...
          <div className="bg-brand-gray-light border-l-4 border-brand-green rounded-2xl p-8 max-w-3xl mx-auto">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <div className="text-xs text-brand-gray-warm">Dein Immobilienmakler in Oberursel</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Oberursel verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Oberursel" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-left md:text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">deine Immobilie in Oberursel. Unser Einsatz. Ihr Erfolg.</h2>
      ...
      {/* FAQ */}
      <section id="faq">
        <FAQ items={faqItems} title="Häufige Fragen – Immobilienmakler Oberursel." />
      </section>
      ...
      <NearbyStaedte currentSlug="oberursel" />
