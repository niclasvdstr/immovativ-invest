...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Immobilienmakler Mainz – immovativInvest',
    description: 'Ihre Immobilie in Mainz professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-mainz',
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Mainz',
    description: 'Wir kennen Altstadt, Gonsenheim, Bretzenheim, Hechtsheim und alle weiteren Stadtteile und wissen, welche Lagen bei Käufern besonders gefragt sind.',
  },
  {
    icon: '🎓',
    title: 'Universitätsstadt mit stabiler Nachfrage',
    description: 'Die Johannes Gutenberg-Universität und internationale Unternehmen wie ZDF und Boehringer Ingelheim sorgen für konstanten Zuzug und stabile Immobilienwerte.',
  },
  {
    icon: '🌊',
    title: 'Rheinlage als Premiumargument',
    description: 'Mainz\' Lage direkt am Rhein mit Blick auf Wiesbaden ist ein starkes Kaufargument, das wir aktiv in der Vermarktung einsetzen.',
  },
  {
    icon: '🤝',
    title: 'Starkes Käufernetzwerk',
    description: 'Unser Netzwerk aus Kaufinteressenten aus Frankfurt, Wiesbaden und dem gesamten Rhein-Main-Gebiet sorgt für schnelle Abschlüsse.',
  },
  {
    icon: '📸',
    title: 'Professionelle Vermarktung',
    description: 'Hochwertige Fotos, überzeugende Exposés und gezielte Online-Kampagnen bringen deine Immobilie in Mainz optimal in Szene.',
  },
  {
    icon: '🔑',
...
const processSteps = [
  {
    ...
    description: 'Wir lernen deine Immobilie in Mainz kennen – ob Altbauwohnung in der Altstadt oder Einfamilienhaus in Gonsenheim.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Transaktionsdaten aus Mainz und der Rhein-Main-Region.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Exklusive Vermarktung',
    description: 'Professionelle Präsentation und gezielte Ansprache kaufkräftiger Interessenten aus Frankfurt, Wiesbaden und dem Rhein-Main-Gebiet.',
  },
  {
    number: 4,
    icon: '🏆',
    title: 'Verkauf zum Toppreis',
    description: 'Wir verhandeln und begleiten bis zur Vertragsunterzeichnung – diskret und professionell.',
  },
]

const stadtteilPreise = [
  { name: 'Altstadt', preis: '5.000–8.000 €/m²', beschreibung: 'Historisches Zentrum, Dom-Nähe, sehr begehrt' },
  { name: 'Gonsenheim', preis: '4.500–6.000 €/m²', beschreibung: 'Beliebte Wohnlage, gute Schulen' },
  { name: 'Bretzenheim', preis: '4.000–5.500 €/m²', beschreibung: 'Familienfreundlich, ruhige Wohnlage' },
  { name: 'Hechtsheim', preis: '4.000–5.500 €/m²', beschreibung: 'Aufstrebend, Neubaugebiete' },
  { name: 'Lerchenberg', preis: '3.800–5.000 €/m²', beschreibung: 'ZDF-Viertel, ruhige Höhenlage' },
...
export default function ImmobilienmaklerMainzPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Mainz" slug="mainz" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Mainz.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Landeshauptstadt Rheinland-Pfalz direkt am Rhein – mit starkem Immobilienmarkt.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Mainz und die Rhein-Main-Region. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Lokale Expertise in Mainz und der Rhein-Main-Region',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Mainz" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Mainz</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Mainz – Universitätsstadt und Medienmetropole<br />
                <span className="text-brand-green">mit dynamischem Immobilienmarkt am Rhein.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Mainz ist Landeshauptstadt von Rheinland-Pfalz und einer der faszinierendsten Immobilienstandorte im Rhein-Main-Gebiet. Die Universität Mainz, internationale Medienunternehmen wie ZDF und die direkte Lage am Rhein machen Mainz zu einer gefragten Stadt für Fachkräfte, Familien und Investoren.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als Immobilienmakler mit Expertise in der gesamten Rhein-Main-Region kennen wir die Besonderheiten des Mainzer Markts – von der historischen Altstadt bis zu den modernen Neubaugebieten in Gonsenheim und Bretzenheim.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Einwohner', value: '218.000', sub: 'Stadt Mainz' },
                  { label: 'Ø Hauspreis', value: '550.000 €', sub: 'Einfamilienhaus Mainz' },
                  { label: 'Ø m²-Preis', value: '4.800 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Wiesbaden', value: '15 km', sub: 'Direkte Rheinbrücke' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&h=600&fit=crop" alt="Immobilien Mainz Rhein" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
              <div className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-medium border border-brand-gray-border px-5 py-4">
                <div className="text-2xl font-bold text-brand-green">+16%</div>
        ...
        <div className="container-max">
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              Stadtteile & Preise in <span className="text-brand-green">Mainz</span>
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Aktuelle Marktpreise nach Mainzer Stadtteilen – als Orientierung für deinen Verkauf.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {stadtteilPreise.map(stadtteil => (
              <div key={stadtteil.name} className="bg-white rounded-2xl p-6 border border-brand-gray-border shadow-sm hover:shadow-medium transition-shadow">
                <div className="flex items-start justify-between mb-3">
                  <h3 className="text-lg font-bold text-brand-anthrazit">{stadtteil.name}</h3>
                </div>
                <div className="text-brand-green font-bold text-xl mb-2">{stadtteil.preis}</div>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Mainz"
        ...
        <div className="container-max">
          <div className="bg-brand-green-50 border border-brand-green-100 rounded-3xl p-8 md:p-12">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                <div className="inline-flex items-center gap-2 bg-brand-green text-white rounded-full px-4 py-1.5 text-sm font-semibold mb-4">
                  💡 Niclas-Tipp für Mainz
                </div>
                <p className="text-brand-anthrazit text-lg leading-relaxed mb-4">
                  "Mainz ist einer der spannendsten Märkte im Rhein-Main-Gebiet – mit der Nähe zu Wiesbaden und Frankfurt, aber eigenem Charakter und oft günstigeren Preisen. Diesen Standortvorteil kommuniziere ich aktiv an die richtigen Käufer."
                </p>
                <div className="font-semibold text-brand-anthrazit">Niclas van der Straeten</div>
                <div className="text-brand-gray-warm text-sm">Immobilienmakler – immovativ<span className="font-black">Invest</span></div>
              </div>
            </div>
          </div>
        </div>
  ...
  Immobilienbewertung starten →
      ...
      <NearbyStaedte currentSlug="mainz" />
