...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Immobilienmakler Limburg an der Lahn – immovativInvest',
    description: 'Ihre Immobilie in Limburg an der Lahn professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-limburg',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Limburg',
    description: 'Wir kennen den Immobilienmarkt in Limburg an der Lahn und dem Landkreis genau – Preise, Nachfrage und die besonderen Qualitäten der attraktiven Kreisstadt mit ICE-Anbindung.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Limburg und dem gesamten Lahn-Dill-Gebiet.',
  },
  {
    icon: '📣',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Limburg und deine Ziele kennen.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir erstellen eine fundierte Marktpreisanalyse für Limburg an der Lahn und legen gemeinsam den optimalen Verkaufspreis fest.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerLimburgPage() {
  return (
    <>
    <CityJsonLd cityName="Limburg an der Lahn" slug="limburg" />
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Limburg an der Lahn</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-6">
                Immobilienmakler
                <span className="text-brand-green"> Limburg.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-8">
                Dein Immobilienexperte für Limburg an der Lahn und den Landkreis Limburg-Weilburg. Wir vermarkten deine Immobilie professionell in der attraktiven Kreisstadt mit ICE-Anbindung und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Limburg an der Lahn" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Limburg</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Limburg an der Lahn
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Limburg an der Lahn – <span className="text-brand-green">Attraktive Kreisstadt mit ICE-Anbindung an der Lahn.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Limburg an der Lahn ist Kreisstadt mit überregionaler Bedeutung: Der Dom, die malerische Altstadt und der ICE-Bahnhof machen die Stadt zu einem der bekanntesten Wohnstandorte in Mittelhessen. Die Hochgeschwindigkeitsverbindung bringt Frankfurt in unter 30 Minuten und Köln in rund einer Stunde erreichbar.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die typische Käufernachfrage, die Preisunterschiede zwischen den Stadtteilen und die aktuellen Markttrends – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg in Limburg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '400.000 €', sub: 'Einfamilienhaus Limburg' },
                  { label: 'Ø m²-Preis', value: '3.100 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '70 km', sub: 'A3 / ICE' },
                  { label: 'Einwohner', value: '~85.000', sub: 'Stadt Limburg a. d. Lahn' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop" alt="Immobilien Limburg an der Lahn" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Limburg.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Limburg an der Lahn.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Limburg"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Limburg verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Limburg an der Lahn" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-left md:text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
            deine Immobilie in Limburg. Unser Einsatz. Ihr Erfolg.
          </h2>
      ...
      <NearbyStaedte currentSlug="limburg" />
