    ...
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-large">
              ...
              <form className="space-y-5" action="#">
                ...
                <button type="submit" className="w-full text-white font-semibold rounded-xl px-6 py-4 text-sm transition-all duration-200 flex items-center justify-center gap-2 whitespace-nowrap" style={{ background: '#16a34a' }}>
      ...
      <section className="py-16 px-4 md:px-8" style={{ background: 'linear-gradient(135deg, #0f2027 0%, #1e3a8a 50%, #0f2027 100%)' }}>
        <div className="max-w-3xl mx-auto text-left md:text-center">
          ...
          <a href="#kontakt" className="inline-flex items-center justify-center font-semibold rounded-xl px-5 md:px-8 py-3.5 md:py-4 text-base md:text-lg bg-white text-brand-anthrazit hover:brightness-105 hover:-translate-y-0.5 transition-all duration-200 w-full">
            Jetzt kostenlos anfragen →
          </a>
        </div>
      </section>
