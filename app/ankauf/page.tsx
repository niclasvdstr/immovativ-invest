            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center font-semibold rounded-2xl border-2 border-[#2563EB] text-[#2563EB] hover:bg-[#2563EB] hover:text-white transition-all duration-200 px-8 py-4 text-lg"
                >
                  Jetzt anrufen
                </a>
              </div>
        ...
        <div className="container-max">
          ...
          <div className="mt-16 flex justify-center mb-6">
            <a
              ...
              download
              className="inline-flex items-center gap-3 text-white font-bold rounded-2xl px-10 py-5 text-base transition-opacity hover:opacity-90 shadow-xl"
              style={{ background: 'linear-gradient(135deg, #1e3a8a 0%, #2563EB 100%)' }}
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
