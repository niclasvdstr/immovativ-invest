  ...
  return (
    <main className="min-h-screen bg-white">
              ...
              <div className="inline-flex items-center gap-2 mb-5">
                ...
                <div>
                  <div className="flex gap-0.5 mb-0.5">
                    {[1,2,3,4,5].map(i => (
                      <svg key={i} style={{ color: '#ffa61c' }} className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
                    ))}
                  </div>
                  <p className="text-xs font-medium text-brand-anthrazit">
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-start">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-3 btn-gradient text-white font-semibold rounded-xl px-5 py-3 text-sm sm:px-7 sm:py-4 transition-colors"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1ebe5a] text-white font-semibold rounded-xl px-5 py-3 text-sm sm:px-7 sm:py-4 transition-colors"
                >
      ...
      <section className="py-16 px-4 md:px-8" style={{ background: 'linear-gradient(135deg, #0f2027 0%, #1e3a8a 50%, #0f2027 100%)' }}>
        <AnimateIn direction="up">
          <div className="max-w-3xl mx-auto text-left md:text-center">
            ...
            <a href="#kontakt" className="inline-flex items-center justify-center font-semibold rounded-xl px-5 md:px-8 py-3.5 md:py-4 text-base md:text-lg bg-white text-brand-anthrazit hover:brightness-105 hover:-translate-y-0.5 transition-all duration-200 w-full sm:w-auto">
      ...
      <section className="py-14 px-4 md:px-8 bg-brand-gray-light">
        <div className="container-max">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-10 text-left">
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {[
              'Hochtaunuskreis', 'Wetteraukreis', 'Frankfurt am Main', 'Landkreis Offenbach',
              'Offenbach am Main', 'Main-Kinzig-Kreis', 'Kreis Groß-Gerau', 'Main-Taunus-Kreis',
              'Landkreis Limburg-Weilburg', 'Rheingau-Taunus-Kreis', 'Darmstadt', 'Wiesbaden',
              'Mainz', 'Landkreis Gießen',
            ].map(region => {
