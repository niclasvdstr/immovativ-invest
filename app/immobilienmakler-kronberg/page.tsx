...
export const metadata: Metadata = {
  title: 'Immobilienmakler Kronberg im Taunus – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Kronberg im Taunus. Professioneller Verkauf exklusiver Villen und Luxusimmobilien – marktgerechte Bewertung, diskrete Vermarktung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Kronberg, Immobilien Kronberg im Taunus, Haus verkaufen Kronberg, Villa verkaufen Kronberg, Hochtaunuskreis Luxusimmobilien, Immobilienbewertung Kronberg, Villen Taunus',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-kronberg' },
  openGraph: {
    title: 'Immobilienmakler Kronberg im Taunus – immovativInvest',
    description: 'Ihre Immobilie in Kronberg im Taunus professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-kronberg',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Kronberg',
    description: 'Wir kennen den exklusiven Immobilienmarkt in Kronberg genau – von der historischen Altstadt und Burg bis zu den Villenvierteln in Schönberg und Oberhöchstadt.',
  },
  {
    icon: '🏰',
    title: 'Expertise für Villen & Premiumbewertung',
    description: 'Kronberg ist berühmt für seine herrschaftlichen Villen. Wir vermarkten exklusive Objekte mit einem Ø m²-Preis von 7.000 € mit dem nötigen Sachverstand.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Kronberg und dem gesamten Premiumsegment des Hochtaunuskreises.',
  },
  {
    icon: '⏱️',
  ...
  {
    icon: '🤝',
    title: 'Diskretes Netzwerk kaufkräftiger Käufer',
    description: 'Viele Kronberger Immobilien werden diskret vermittelt. Wir verfügen über ein exklusives Netzwerk qualifizierter Kaufinteressenten.',
  },
  {
    icon: '🔑',
...
const processSteps = [
  {
    ...
    description: 'In einem vertraulichen Gespräch lernen wir deine Immobilie in Kronberg kennen – ob historische Villa in der Altstadt, Anwesen in Schönberg oder modernes Einfamilienhaus in Oberhöchstadt.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Premiumberatung & Wertermittlung',
    description: 'Wir ermitteln den Marktwert deiner Kronberger Immobilie präzise – unter Berücksichtigung der einzigartigen Lage am Taunushang, Architektur und historischem Charme.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Exklusive Vermarktung',
    description: 'Hochwertige Präsentation mit professionellen Fotos, Luftaufnahmen und diskreter Vermarktung an unser Netzwerk kaufkräftiger Interessenten in Frankfurt und darüber hinaus.',
  },
  {
    number: 4,
    icon: '🏆',
    title: 'Erfolgreicher Abschluss',
    description: 'Wir verhandeln auf Augenhöhe mit anspruchsvollen Käufern und begleiten dich bis zur notariellen Vertragsunterzeichnung – diskret und professionell.',
  },
]
...
const stadtteilPreise = [
  ...
  { name: 'Schönberg', preis: '7.000–12.000 €/m²', beschreibung: 'Villenviertel, internationales Publikum' },
  { name: 'Falkenstein', preis: '6.000–10.000 €/m²', beschreibung: 'Hochwertige Lagen am Waldesrand' },
  { name: 'Oberhöchstadt', preis: '5.500–8.000 €/m²', beschreibung: 'Dörflicher Charme, Taunusblick' },
]

const niclasText = "In Kronberg entscheidet nicht die Reichweite, sondern das Netzwerk. Viele der hochwertigsten Transaktionen laufen hier völlig diskret ab – direkt zwischen uns und vorgemerkten Kaufinteressenten, ohne öffentliche Anzeige. Das ist der Kronberg-Weg."
...
export default function ImmobilienmaklerKronbergPage() {
  return (
    <>
    <CityJsonLd cityName="Kronberg im Taunus" slug="kronberg" />
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Kronberg</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Kronberg.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Villenstadt mit historischem Charme direkt am Taunushang.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Kronberg im Taunus. Wir vermarkten exklusive Villen und Immobilien professionell und diskret – für den bestmöglichen Preis in einer der attraktivsten Lagen des Rhein-Main-Gebiets.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Spezialisiert auf Villen & Premiumobjekte im Taunus',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Kronberg" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Kronberg</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„Kronberg ist ein Markt, wo die richtigen Käufer nicht auf Immoscout suchen – sie warten auf einen Anruf. Mein Job ist es, genau diese Verbindung herzustellen."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Hanglagen mit Frankfurter Skyline-Blick und historische Villen sind die begehrten Objekte in Kronberg. Der Käuferkreis kommt aus dem Frankfurter Unternehmens- und Bankensektor. Diskretion ist bei fast jedem Kronberger Verkauf das oberste Gebot.</p>
          </div>
          </AnimateIn>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Kronberg
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Kronberg – Villenstadt<br />
                <span className="text-brand-green">mit historischem Charme am Taunushang.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Kronberg im Taunus ist bekannt für seine prachtvolle Burg, die historische Altstadt und vor allem für seine herrschaftlichen Villen. Nur 16 km von Frankfurt entfernt und per S4 sowie A661 optimal angebunden, zieht Kronberg seit Generationen die Prominenz und Führungskräfte aus der Finanzmetropole an.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als Immobilienmakler für das Premiumsegment kennen wir die Qualitätsmerkmale, die Kronberger Immobilien einzigartig machen – historische Bausubstanz, große Grundstücke und unverbaubare Taunusblicke – und wissen, wie man diese Vorzüge optimal in Szene setzt.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '1.100.000 €', sub: 'Einfamilienhaus Kronberg' },
                  { label: 'Ø m²-Preis', value: '7.000 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '16 km', sub: 'A661 / S4' },
                  { label: 'Einwohner', value: '~18.000', sub: 'Stadt Kronberg' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop" alt="Immobilien Kronberg Hochtaunuskreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-10">
            <h2 className="text-3xl font-bold text-brand-anthrazit mb-3">
              Immobilienpreise nach <span className="text-brand-green">Stadtteil in Kronberg.</span>
            </h2>
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Kronberg.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise im Villen- und Luxussegment kombiniert mit professioneller Vermarktung – für den bestmöglichen Preis deiner Kronberger Immobilie.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Kronberg"
        subtitle="Diskret, professionell und vollständig in deinem eigenen Tempo."
      />
          ...
          <div className="bg-brand-gray-light border-l-4 border-brand-green rounded-2xl p-8 max-w-3xl mx-auto">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <div className="text-xs text-brand-gray-warm">Dein Immobilienmakler in Kronberg</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Kronberg verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Kronberg" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8" style={{ background: 'linear-gradient(135deg, #1e3a8a 0%, #2563EB 60%, #16a34a 100%)' }}>
        <div className="max-w-3xl mx-auto text-left md:text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">deine Immobilie in Kronberg. Unser Einsatz. Ihr Erfolg.</h2>
      ...
      {/* FAQ */}
      <section id="faq">
        <FAQ items={faqItems} title="Häufige Fragen – Immobilienmakler Kronberg." />
      </section>
      ...
      <NearbyStaedte currentSlug="kronberg" />
