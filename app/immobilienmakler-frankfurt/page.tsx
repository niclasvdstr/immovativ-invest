...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Immobilienmakler Frankfurt am Main – Immobilie verkaufen | immovativInvest',
    description: 'Professioneller Immobilienverkauf in Frankfurt am Main. Lokale Marktkenntnis, transparente Beratung, maximaler Verkaufspreis.',
    url: 'https://www.immovativ-invest.de/immobilienmakler-frankfurt',
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Frankfurt am Main',
    description: 'Wir kennen jeden Stadtteil – von Sachsenhausen über das Westend bis nach Bornheim. Unsere Expertise in Frankfurts Teilmärkten sichert dir den besten Preis.',
  },
  {
    icon: '🚀',
    title: 'Schnelle Verkaufsabwicklung',
    description: 'Durch unser Netzwerk aus vorgemerkten Käufern erzielen wir schnelle Abschlüsse – ohne Kompromisse beim Verkaufspreis.',
  },
  {
    icon: '📊',
    title: 'Professionelle Immobilienbewertung',
    description: 'Unsere marktgenaue Bewertung basiert auf aktuellen Transaktionsdaten aus Frankfurt und der gesamten Rhein-Main-Region.',
  },
  {
    icon: '🤫',
    title: 'Diskrete Vermarktung',
    description: 'Auf Wunsch vermarkten wir deine Immobilie vertraulich – ohne öffentliche Anzeigen, direkt an qualifizierte Interessenten.',
  },
  {
    icon: '🔄',
    title: 'Vollservice ohne Aufwand',
    description: 'Von der Bewertung über Expose und Besichtigungen bis zur Notarunterschrift – wir übernehmen alles für dich.',
  },
  {
    icon: '🔑',
...
const processSteps = [
  {
    ...
    description: 'Wir bewerten deine Immobilie in Frankfurt am Main kostenlos und unverbindlich auf Basis aktueller Marktdaten.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Vermarktungsstrategie',
    description: 'Wir entwickeln eine maßgeschneiderte Strategie – professionelle Fotos, Grundrisse, Expose und zielgerichtete Ansprache.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Besichtigungen & Verhandlung',
    description: 'Wir koordinieren alle Besichtigungen, prüfen Interessenten und verhandeln den bestmöglichen Preis für dich.',
  },
  {
    number: 4,
    icon: '🏆',
    title: 'Notartermin & Übergabe',
    description: 'Wir begleiten dich bis zur Schlüsselübergabe – inklusive Vorbereitung des Kaufvertrags und Notartermins.',
  },
]
...
const stadtteilPreise = [
  ...
  { name: 'Nordend', preis: '6.500–8.500 €/m²', beschreibung: 'Beliebtes Gründerzeitviertel, sehr nachgefragt' },
  { name: 'Sachsenhausen', preis: '6.500–8.000 €/m²', beschreibung: 'Museumsmeile, Apfelwein, hohe Lebensqualität' },
  { name: 'Bornheim', preis: '6.000–7.500 €/m²', beschreibung: 'Urban, jung, starke Kaufnachfrage' },
  { name: 'Ostend', preis: '5.500–7.000 €/m²', beschreibung: 'Trendig, EZB-Nähe, stark aufgewertet' },
  { name: 'Bockenheim', preis: '5.500–6.500 €/m²', beschreibung: 'Studentenviertel mit guter Infrastruktur' },
  { name: 'Rödelheim', preis: '5.000–6.000 €/m²', beschreibung: 'Aufstrebend, familienfreundlich' },
  { name: 'Höchst', preis: '4.000–5.500 €/m²', beschreibung: 'Einstiegslage mit Entwicklungspotenzial' },
]

export default function ImmobilienmaklerFrankfurt() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Frankfurt am Main" slug="frankfurt" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-brand-anthrazit">
                    <span className="font-bold">4,9 von 5</span> Sternen – über 120 erfolgreiche Verkäufe
                  </p>
                </div>
              </div>
              ...
              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Deutschlands Finanzmetropole mit dynamischem Immobilienmarkt.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Frankfurt am Main und die gesamte Rhein-Main-Region. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
              ...
              <ul className="space-y-5 mb-10">
                {[
                  ...
                  'Persönliche Beratung vor Ort in Frankfurt',
                ].map(item => (
            ...
            {/* Feature panel – Niclas image card */}
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Frankfurt am Main" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Frankfurt am Main</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
                <p className="text-gray-600 text-sm leading-relaxed mb-3">Frankfurt ist der schnellste Markt, in dem ich arbeite. In Sachsenhausen, Bornheim oder dem Westend gibt es Wohnungen, die am Montag besichtigt und am Freitag unterschrieben werden. Wer den richtigen Preis ansetzt, muss nicht lange warten.</p>
                <p className="text-gray-600 text-sm leading-relaxed mb-5">Ich kenne die Preisunterschiede zwischen den Stadtteilen aus eigener Erfahrung: Was in Sachsenhausen als Altbau geht, funktioniert in Rödelheim anders. Ich setze diese Kenntnis ein, damit du den maximalen Marktpreis erzielst – nicht nur einen Durchschnittswert.</p>
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„In Frankfurt-Sachsenhausen habe ich zuletzt drei Eigentumswohnungen innerhalb einer Woche verkauft – der Markt dort ist schnell, kaufkräftig und reaktiv. Richtig aufbereitet, kommt das erste Angebot oft noch am Tag der Besichtigung."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Besonders stark nachgefragt: Altbauwohnungen in Sachsenhausen, Bornheim und Nordend, Neubauprojekte im Europaviertel, Villen in Sachsenhausen und Westend. Internationale Käufer – besonders aus dem Bankensektor – spielen in Frankfurt eine größere Rolle als irgendwo sonst in der Region.</p>
          </div>
          </AnimateIn>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Frankfurt – Europäisches Finanzzentrum<br />
                <span className="text-brand-green">mit einem der stärksten Immobilienmärkte Deutschlands.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Frankfurts Immobilienmarkt ist geprägt von seiner einzigartigen Rolle als internationales Finanzzentrum mit Skyline-Flair. Hohe Kaufkraft, kontinuierliche Zuzüge aus dem In- und Ausland sowie eine starke Wirtschaftsstruktur sorgen für anhaltende Nachfrage – von der klassischen Gründerzeitwohnung im Nordend bis zum Penthouse mit Skyline-Blick im Westend.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Besonderheiten jedes Stadtteils, die aktuellen Preisentwicklungen und die Nachfrage verschiedener Käufergruppen – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '750.000 €', sub: 'Einfamilienhaus Frankfurt' },
                  { label: 'Ø m²-Preis', value: '6.500 €', sub: 'Eigentumswohnung' },
                  { label: 'Einwohner', value: '770.000', sub: 'Stadt Frankfurt am Main' },
                  { label: 'Ranking', value: 'Top 3', sub: 'Teuerste Städte DE' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&h=600&fit=crop" alt="Immobilienmarkt Frankfurt am Main" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
              <div className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-medium border border-brand-gray-border px-5 py-4">
                <div className="text-2xl font-bold text-brand-green">+22%</div>
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-10">
            <h2 className="text-3xl font-bold text-brand-anthrazit mb-3">
              Immobilienpreise nach <span className="text-brand-green">Stadtteil in Frankfurt.</span>
            </h2>
            <p className="text-brand-gray-warm md:max-w-2xl md:mx-auto">
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Frankfurt.
            </h2>
            <p className="text-brand-gray-warm text-lg md:max-w-2xl md:mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Frankfurt am Main.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Frankfurt"
          ...
          <div className="bg-brand-gray-light border-l-4 border-brand-green rounded-2xl p-8 max-w-3xl mx-auto">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <div className="text-xs text-brand-gray-warm">Dein Immobilienmakler in Frankfurt am Main</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Frankfurt am Main verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Frankfurt am Main" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="bewertungen">
        <Testimonials title="Eigentümer aus Frankfurt, die uns vertrauen" />
      </section>

      {/* CTA Banner */}
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-left md:text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">deine Immobilie in Frankfurt am Main. Unser Einsatz. Ihr Erfolg.</h2>
      ...
      {/* FAQ */}
      <section id="faq">
        <FAQ items={faqItems} title="Häufige Fragen – Immobilienmakler Frankfurt am Main." />
      </section>
      ...
      <NearbyStaedte currentSlug="frankfurt" />
