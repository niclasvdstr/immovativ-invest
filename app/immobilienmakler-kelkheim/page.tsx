...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Immobilienmakler Kelkheim (Taunus) – immovativInvest',
    description: 'Ihre Immobilie in Kelkheim professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-kelkheim',
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Kelkheim',
    description: 'Wir kennen den Immobilienmarkt in Kelkheim genau – von Münster über Hornau und Fischbach bis nach Ruppertshain und Eppenhain.',
  },
  {
    icon: '🌿',
    title: 'Expertise in gehobener Taunuslage',
    description: 'Kelkheim bietet ruhige Wohnlagen am Taunus mit hervorragender Anbindung nach Frankfurt. Wir vermarkten deine Immobilie gezielt an Familien und Naturliebhaber.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Kelkheim – mit einem Ø m²-Preis von 5.100 € kennen wir jede Marktfacette.',
  },
  {
    icon: '⏱️',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Kelkheim kennen – ob Einfamilienhaus in Münster, Villa in Fischbach oder Reihenhaus in Hornau.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Kelkheim und dem Main-Taunus-Kreis.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerKelkheimPage() {
  return (
    <>
    <CityJsonLd cityName="Kelkheim" slug="kelkheim" />
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Kelkheim</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Kelkheim.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Ruhige Taunusgemeinde mit gehobener Wohnlage nahe Frankfurt.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Kelkheim (Taunus) und den Main-Taunus-Kreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Kelkheim" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Kelkheim</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Kelkheim
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Kelkheim – Ruhige Taunusgemeinde<br />
                <span className="text-brand-green">mit gehobener Wohnlage nahe Frankfurt.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Kelkheim (Taunus) liegt eingebettet in die grünen Hänge des Taunus und bietet seinen rund 28.000 Einwohnern eine hohe Lebensqualität. Die Nähe zur Natur kombiniert mit guter Infrastruktur macht Kelkheim besonders bei Familien und Naturliebhabern beliebt.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Unterschiede zwischen den Stadtteilen, die Erwartungen anspruchsvoller Käufer und die aktuellen Markttrends – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '720.000 €', sub: 'Einfamilienhaus Kelkheim' },
                  { label: 'Ø m²-Preis', value: '5.100 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '18 km', sub: 'A66 / S2' },
                  { label: 'Einwohner', value: '~28.000', sub: 'Stadt Kelkheim' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800&h=600&fit=crop" alt="Immobilien Kelkheim Taunus" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Kelkheim.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Kelkheim.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Kelkheim"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Kelkheim verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Kelkheim" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <ContactForm
        variant="makler"
        title="Kostenlose Erstberatung in Kelkheim anfordern."
      ...
      <NearbyStaedte currentSlug="kelkheim" />
