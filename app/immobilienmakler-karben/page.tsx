...
export const metadata: Metadata = {
  title: 'Immobilienmakler Karben – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Karben im Wetteraukreis. Professioneller Verkauf von Immobilien in der wachsenden S-Bahn-Stadt nahe Frankfurt – marktgerechte Bewertung, persönliche Betreuung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Karben, Immobilien Karben, Haus verkaufen Karben, Wohnung verkaufen Karben, Wetteraukreis Immobilien, Immobilienbewertung Karben, Klein-Karben Groß-Karben Kloppenheim Immobilien',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-karben' },
  openGraph: {
    title: 'Immobilienmakler Karben – immovativInvest',
    description: 'Ihre Immobilie in Karben professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-karben',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Karben',
    description: 'Wir kennen den Immobilienmarkt in Karben genau – von Klein-Karben und Groß-Karben über Kloppenheim und Rendel bis nach Okarben und Petterweil.',
  },
  {
    icon: '📈',
    title: 'Expertise im Wachstumsmarkt',
    description: 'Karben wächst kontinuierlich und zieht Familien und Pendler an. Durch die S6-Anbindung und die Nähe zu Bad Vilbel und Frankfurt ist die Nachfrage nach Immobilien hoch.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Karben – mit einem Ø m²-Preis von 3.800 € kennen wir jede Marktfacette.',
  },
  {
    icon: '⏱️',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Karben kennen – ob Einfamilienhaus in Klein-Karben, Reihenhaus in Kloppenheim oder Wohnung in Groß-Karben.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Karben und dem Wetteraukreis.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerKarbenPage() {
  return (
    <>
    <CityJsonLd cityName="Karben" slug="karben" />
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Karben</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Karben.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Wachsende Wetterau-Stadt mit S-Bahn-Anbindung nach Frankfurt.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Karben und den Wetteraukreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Karben" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Karben</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„Karben hat einen stabilen, bodenständigen Markt – keine Hype-Preise, aber auch kein Überangebot. Wer hier verkauft, findet zuverlässig ernsthafte Käufer."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Besonders gefragt sind Klein-Karben und Rendel für ihre ruhigen Einfamilienhauslagen. Objekte mit Garten und Garage erzielen die besten Preise. Die Nachfrage kommt überwiegend aus Frankfurt und Bad Vilbel.</p>
          </div>
          </AnimateIn>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Karben
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Karben – Wachsende Wetterau-Stadt<br />
                <span className="text-brand-green">mit S-Bahn-Anbindung nach Frankfurt.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Karben im Wetteraukreis erfreut sich wachsender Beliebtheit. Die sechs Stadtteile bieten eine ruhige, grüne Wohnqualität in der Wetterau bei gleichzeitig guter Anbindung über die S6 und A661 nach Frankfurt und Bad Vilbel.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Unterschiede zwischen den Stadtteilen, die Nachfrage von Familien und Pendlern und die aktuellen Preisentwicklungen – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '520.000 €', sub: 'Einfamilienhaus Karben' },
                  { label: 'Ø m²-Preis', value: '3.800 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '18 km', sub: 'A661 / S6' },
                  { label: 'Einwohner', value: '~22.000', sub: 'Stadt Karben' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&h=600&fit=crop" alt="Immobilien Karben Wetteraukreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Karben.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Karben.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Karben"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Karben verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Karben" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <ContactForm
        variant="makler"
        title="Kostenlose Erstberatung in Karben anfordern."
      ...
      <NearbyStaedte currentSlug="karben" />
