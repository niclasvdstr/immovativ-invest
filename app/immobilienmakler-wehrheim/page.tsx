...
export const metadata: Metadata = {
  title: 'Immobilienmakler Wehrheim – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Wehrheim & Hochtaunuskreis. Professioneller Immobilienverkauf mit marktgerechter Bewertung, persönlicher Betreuung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Wehrheim, Immobilien Wehrheim, Haus verkaufen Wehrheim, Wohnung verkaufen Wehrheim, Hochtaunuskreis Immobilien, Immobilienbewertung Wehrheim',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-wehrheim' },
  openGraph: {
    title: 'Immobilienmakler Wehrheim – immovativInvest',
    description: 'Ihre Immobilie in Wehrheim professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-wehrheim',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Wehrheim',
    description: 'Wir kennen den Immobilienmarkt in Wehrheim und dem Hochtaunuskreis genau – Preise, Nachfrage und Besonderheiten vor Ort.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Wehrheim und dem gesamten Taunus-Raum.',
  },
  {
    icon: '📣',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Wehrheim und deine Ziele kennen.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir erstellen eine fundierte Marktpreisanalyse für Wehrheim und legen gemeinsam den optimalen Verkaufspreis fest.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerWehrheimPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Wehrheim" slug="wehrheim" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Wehrheim</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-6">
                Immobilienmakler
                <span className="text-brand-green"> Wehrheim.</span>
              </h1>
              <p className="text-brand-gray-warm text-lg leading-relaxed mb-8">
                Dein Immobilienexperte für Wehrheim und den Hochtaunuskreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Wehrheim" className="w-full h-64 object-cover" style={{ objectPosition: 'center 15%' }} width={800} height={256} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Wehrheim</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„Wehrheim ist nichts für jeden – aber für die Richtigen ist es perfekt. Und wenn ich die richtigen Käufer finde, gibt es selten Verhandlungen über den Preis."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Ruhige Dorflagen, große Grundstücke und direkter Taunuszugang sind die zentralen Verkaufsargumente. Käufer sind überwiegend Paare und Familien, die bewusst aus städtischen Strukturen aussteigen wollen.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Wehrheim
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Wehrheim – naturnahes Wohnen<br />
                <span className="text-brand-green">im Taunus.</span>
              </h2>
              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Wehrheim liegt im Hochtaunuskreis und überzeugt mit idyllischer Taunuslage, ruhigem Wohnumfeld und guter Infrastruktur. Die Gemeinde ist bei Familien und Naturliebhabern gleichermaßen beliebt und bietet eine stabile Nachfrage nach Wohnimmobilien.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Besonderheiten des Wehrheimer Markts und setzen dieses Wissen gezielt für deinen Verkaufserfolg ein.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '520.000 €', sub: 'Einfamilienhaus Wehrheim' },
                  { label: 'Ø m²-Preis', value: '3.400 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '32 km', sub: 'A5 / B456' },
                  { label: 'Einwohner', value: '~8.000', sub: 'Gemeinde Wehrheim' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop" alt="Immobilien Wehrheim Hochtaunuskreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Wehrheim.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Wehrheim.
            </p>
          </div>
      ...
      <ProcessSteps steps={processSteps} title="In 4 Schritten zum Verkauf in Wehrheim" subtitle="Unkompliziert, transparent und vollständig in deinem eigenen Tempo." />
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Wehrheim verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Wehrheim" className="w-full h-[480px] object-cover rounded-3xl shadow-large" style={{ objectPosition: 'center 20%' }} width={800} height={480} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-left md:text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">deine Immobilie in Wehrheim. Unser Einsatz. Ihr Erfolg.</h2>
      ...
      <NearbyStaedte currentSlug="wehrheim" />
