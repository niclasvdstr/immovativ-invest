...
export const metadata: Metadata = {
  title: 'Immobilienmakler Idstein – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Idstein im Rheingau-Taunus-Kreis. Professioneller Verkauf von Immobilien in der historischen Fachwerkstadt im Taunus – marktgerechte Bewertung, persönliche Betreuung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Idstein, Immobilien Idstein, Haus verkaufen Idstein, Wohnung verkaufen Idstein, Rheingau-Taunus-Kreis Immobilien, Immobilienbewertung Idstein, Hexenturm Altstadt Fachwerk Immobilien',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-idstein' },
  openGraph: {
    title: 'Immobilienmakler Idstein – immovativInvest',
    description: 'Ihre Immobilie in Idstein professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-idstein',
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Idstein',
    description: 'Wir kennen den Immobilienmarkt in Idstein genau – von der historischen Altstadt über Heftrich und Walsdorf bis nach Wörsdorf und Dasbach.',
  },
  {
    icon: '🏰',
    title: 'Expertise in historischen Lagen',
    description: 'Idsteins mittelalterliche Altstadt mit Hexenturm und Fachwerkhäusern macht die Stadt einzigartig. Wir vermarkten historische und moderne Immobilien gleichermaßen professionell.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Idstein – mit einem Ø m²-Preis von 3.700 € kennen wir jede Marktfacette.',
  },
  {
    icon: '⏱️',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Idstein kennen – ob Fachwerkhaus in der Altstadt, Neubau in Wörsdorf oder Einfamilienhaus in Heftrich.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Idstein und dem Rheingau-Taunus-Kreis.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerIdsteinPage() {
  return (
    <>
    <CityJsonLd cityName="Idstein" slug="idstein" />
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Idstein</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Idstein.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Historische Fachwerkstadt im Taunus mit wachsendem Immobilienmarkt.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Idstein und den Rheingau-Taunus-Kreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Lokale Expertise im Rheingau-Taunus-Kreis',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Idstein" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Idstein</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Idstein
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Idstein – Historische Fachwerkstadt<br />
                <span className="text-brand-green">im Taunus mit wachsendem Immobilienmarkt.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Idstein im Rheingau-Taunus-Kreis ist eine der besterhaltenen mittelalterlichen Städte Hessens. Der Hexenturm, das Schloss und hunderte Fachwerkhäuser ziehen Besucher und Neubürger gleichermaßen an. Die gute Autobahnanbindung über A3 und A66 macht Frankfurt in etwa 35 Minuten erreichbar.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Besonderheiten historischer Gebäude, die Unterschiede zwischen den Stadtteilen und die aktuellen Preisentwicklungen – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '520.000 €', sub: 'Einfamilienhaus Idstein' },
                  { label: 'Ø m²-Preis', value: '3.700 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '35 km', sub: 'A3 / A66' },
                  { label: 'Einwohner', value: '~24.000', sub: 'Stadt Idstein' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop" alt="Immobilien Idstein Rheingau-Taunus-Kreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Idstein.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Idstein.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Idstein"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Idstein verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Idstein" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Banner */}
      <section className="py-16 px-4 md:px-8" style={{ background: 'linear-gradient(135deg, #1e3a8a 0%, #2563EB 100%)' }}><div className="max-w-3xl mx-auto text-left md:text-center"><h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Deine Immobilie in Idstein. Dein Erfolg.</h2><p className="text-green-100 mb-6">Kostenlose Erstberatung und Bewertung – ganz ohne Verpflichtung.</p><CTAButton href="/verkaufen" variant="white" size="lg">Immobilienbewertung starten →</CTAButton></div></section>

      <TippgeberSection />

      {/* FAQ */}
      <section id="faq">
        <FAQ items={faqItems} title="Häufige Fragen – Immobilienmakler Idstein." />
      </section>
      ...
      <NearbyStaedte currentSlug="idstein" />
