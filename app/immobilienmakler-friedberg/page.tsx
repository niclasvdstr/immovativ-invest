...
export const metadata: Metadata = {
  title: 'Immobilienmakler Friedberg (Hessen) – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Friedberg (Hessen). Professioneller Verkauf von Immobilien in der Kreisstadt des Wetteraukreises – marktgerechte Bewertung & persönliche Betreuung. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Friedberg, Immobilien Friedberg Hessen, Haus verkaufen Friedberg, Wohnung verkaufen Friedberg, Immobilienbewertung Friedberg, Makler Wetteraukreis',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-friedberg' },
  openGraph: {
    title: 'Immobilienmakler Friedberg (Hessen) – immovativInvest',
    description: 'Ihre Immobilie in Friedberg professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-friedberg',
...
const stadtteilPreise = [
  { name: 'Kernstadt', preis: '3.500–5.000 €/m²', beschreibung: 'Historisches Zentrum, Burg, beste Lage' },
  { name: 'Dorheim', preis: '3.000–4.500 €/m²', beschreibung: 'Ruhige Wohnlage, Neubaugebiete' },
  { name: 'Ockstadt', preis: '3.000–4.200 €/m²', beschreibung: 'Dörflicher Charakter, naturverbunden' },
  { name: 'Fauerbach', preis: '2.800–4.000 €/m²', beschreibung: 'Günstige Einstiegslage' },
  { name: 'Ossenheim', preis: '2.800–3.800 €/m²', beschreibung: 'Ländliche Lage, ruhig' },
]

const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Friedberg',
    description: 'Wir kennen den Immobilienmarkt in Friedberg (Hessen) und dem Wetteraukreis – von der historischen Kernstadt bis zu den ländlichen Stadtteilen.',
  },
  {
    icon: '🏰',
    title: 'Historischer Charme als Verkaufsargument',
    description: 'Die mittelalterliche Burg Friedberg und das historische Stadtbild machen Friedberg unverwechselbar – ein echtes Alleinstellungsmerkmal am Markt.',
  },
  {
    icon: '💶',
    title: 'Attraktive Preise im Wetterau-Vergleich',
    description: 'Friedberg bietet echte Lebensqualität zu fairen Preisen – weit unter Frankfurt-Niveau. Das zieht eine wachsende Gruppe von Käufern an, die aus der Stadt in die Wetterau ausweichen.',
  },
  {
    icon: '🤝',
    title: 'Käufernetzwerk aus der Rhein-Main-Region',
    description: 'Wir sprechen gezielt Käufer aus Frankfurt, Bad Homburg und Hanau an, die in der Wetterau erschwinglichere Immobilien suchen.',
  },
  {
    icon: '📸',
    title: 'Professionelle Vermarktung',
    description: 'Hochwertige Fotos, ansprechende Exposés, gezielte Online-Präsenz auf allen relevanten Immobilienportalen.',
  },
  {
    icon: '🔑',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Friedberg kennen – ob Haus in der Kernstadt nahe der Burg oder Grundstück in Dorheim.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Friedberg und dem Wetteraukreis.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Exklusive Vermarktung',
    description: 'Professionelle Präsentation, gezielte Ansprache von Kaufinteressenten aus der gesamten Rhein-Main-Region sowie qualifizierte Besichtigungen.',
  },
  {
    number: 4,
    icon: '🏆',
...
export default function ImmobilienmaklerFriedbergPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Friedberg" slug="friedberg" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Friedberg</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Friedberg.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Historische Kreisstadt des Wetteraukreises mit stabiler Nachfrage aus der Rhein-Main-Region.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Friedberg (Hessen) und den Wetteraukreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Lokale Expertise im Wetteraukreis',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Friedberg" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Friedberg</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
                <p className="text-gray-600 text-sm leading-relaxed mb-3">Friedberg hat Charme – die historische Stadtmauer, die Burg, das Flair einer gewachsenen Stadt. Und die Preise sind noch moderat, obwohl die S-Bahn-Verbindung nach Frankfurt und in die Wetterau exzellent ist.</p>
                <p className="text-gray-600 text-sm leading-relaxed mb-5">Ich sehe in Friedberg eine wachsende Nachfrage von Käufern, die Bad Vilbel oder Bad Homburg als zu teuer empfinden, aber denselben Pendelkomfort wollen. Diesen Vorteil kommuniziere ich aktiv.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Friedberg – Historische Kreisstadt<br />
                <span className="text-brand-green">im Herzen der Wetterau.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Friedberg (Hessen) ist die Kreisstadt des Wetteraukreises und bietet eine attraktive Kombination aus historischem Charme, guter Infrastruktur und vergleichsweise erschwinglichen Immobilienpreisen. Der mittelalterliche Burgbering und die bekannte Burg Friedberg prägen das Stadtbild.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als Makler kennen wir den Friedberger Markt und die wachsende Nachfrage von Käufern aus Frankfurt und der Rhein-Main-Region, die in die Wetterau ausweichen. Davon profitieren Verkäufer in Friedberg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Einwohner', value: '~30.000', sub: 'Stadt Friedberg' },
                  { label: 'Ø Hauspreis', value: '400.000 €', sub: 'Einfamilienhaus Friedberg' },
                  { label: 'Ø m²-Preis', value: '3.800 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '35 km', sub: 'A5 / Bahn' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&h=600&fit=crop" alt="Immobilien Friedberg Hessen Wetteraukreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
      ...
      <section id="vorteile" className="section-padding bg-white">
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Friedberg.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Friedberg.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Friedberg"
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                <div className="inline-flex items-center gap-2 bg-brand-green text-white rounded-full px-3 py-1 text-xs font-semibold mb-4">
                  💡 Niclas' Tipp für Friedberg
                </div>
                <blockquote className="text-brand-anthrazit text-lg leading-relaxed font-medium italic">
                  "Friedberg ist ideal für Käufer, die echte Lebensqualität zu fairen Preisen suchen – und die Wetterau als Wohnraum entdecken. Diesen Trend nutze ich gezielt: deine Immobilie in Friedberg erreicht die richtigen Kaufinteressenten aus der gesamten Rhein-Main-Region."
                </blockquote>
                <div className="mt-4 text-sm font-semibold text-brand-anthrazit">
                  Niclas van der Straeten – Dein Immobilienmakler in Friedberg
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-brand-gray-light">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Friedberg verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Friedberg" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Banner */}
      <section className="py-16 px-4 md:px-8" style={{ background: 'linear-gradient(135deg, #1e3a8a 0%, #2563EB 100%)' }}><div className="max-w-3xl mx-auto text-left md:text-center"><h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Deine Immobilie in Friedberg. Dein Erfolg.</h2><p className="text-green-100 mb-6">Kostenlose Erstberatung und Bewertung – ganz ohne Verpflichtung.</p><CTAButton href="/verkaufen" variant="white" size="lg">Immobilienbewertung starten →</CTAButton></div></section>
      ...
      <NearbyStaedte currentSlug="friedberg" />
