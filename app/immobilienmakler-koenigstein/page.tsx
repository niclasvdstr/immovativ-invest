...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Königstein',
    description: 'Wir kennen den exklusiven Immobilienmarkt in Königstein genau – von der Altstadt und Burganlage bis zu den Stadtteilen Schneidhain, Fischbach und Mammolshain.',
  },
  {
    icon: '💎',
    title: 'Expertise im Luxussegment',
    description: 'Königstein gehört zu den teuersten Wohnstandorten Deutschlands. Wir vermarkten Luxusimmobilien mit Durchschnittspreisen von 1,2 Mio. € diskret und professionell.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung für das Premiumsegment – auf Basis exklusiver Marktdaten aus Königstein mit einem Ø m²-Preis von 7.500 €.',
  },
  {
    icon: '⏱️',
  ...
  {
    icon: '🤝',
    title: 'Diskretes Netzwerk',
    description: 'Viele Königsteiner Immobilien werden off-market vermittelt. Wir haben Zugang zu einem exklusiven Käufernetzwerk kaufkräftiger Interessenten.',
  },
  {
    icon: '🔑',
...
const processSteps = [
  {
    ...
    description: 'In einem vertraulichen Gespräch lernen wir deine Immobilie in Königstein kennen – ob Villa in Schneidhain, Herrenhaus in Fischbach oder exklusives Anwesen in Mammolshain.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Premiumberatung & Wertermittlung',
    description: 'Wir ermitteln den Marktwert deiner Königsteiner Immobilie präzise – unter Berücksichtigung der einzigartigen Lage, Ausstattung und der aktuellen Nachfrage im Luxussegment.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Exklusive Vermarktung',
    description: 'Hochwertige Präsentation, diskretes Off-Market-Angebot an qualifizierte Kaufinteressenten sowie gezielte Premium-Vermarktung auf nationalen und internationalen Plattformen.',
  },
  {
    number: 4,
    icon: '🏆',
    title: 'Erfolgreicher Abschluss',
    description: 'Wir verhandeln auf Augenhöhe mit kaufkräftigen Käufern und begleiten dich bis zur notariellen Vertragsunterzeichnung – diskret und professionell.',
  },
]
...
export default function ImmobilienmaklerKoenigsteinPage() {
  return (
    <>
    <CityJsonLd cityName="Königstein im Taunus" slug="koenigstein" />
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Königstein</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Königstein.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Eine der exklusivsten Wohnlagen Deutschlands im Taunus.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Königstein im Taunus. Wir vermarkten exklusive Immobilien professionell und diskret – für den bestmöglichen Preis in einer der teuersten Wohnlagen Deutschlands.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Spezialisiert auf Luxusimmobilien im Taunus',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Königstein" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Königstein</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„In Königstein habe ich ein Objekt nie auf einem öffentlichen Portal inseriert. Der Käufer kam aus meinem Netzwerk – diskret, schnell, über Zielpreis."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Königstein gehört zu den wenigen Lagen im Rhein-Main-Gebiet, wo Objekte regelmäßig ohne öffentliche Vermarktung verkauft werden. Die Nachfrage kommt aus der Unternehmer- und Führungskräfte-Schicht des Frankfurter Raums. Diskretion ist hier Standard.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Königstein
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Königstein – exklusive Taunuslage<br />
                <span className="text-brand-green">mit höchster Kaufkraft Deutschlands.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Königstein im Taunus gehört zu den wenigen Gemeinden in Deutschland, in denen die durchschnittlichen Hauspreise die Millionengrenze überschreiten. Die einzigartige Kombination aus historischer Burgruine, exklusiven Villengegenden und direkter A66/B8-Anbindung nach Frankfurt (20 km) macht Königstein zur Traumlage für anspruchsvolle Käufer.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als Immobilienmakler für das Premiumsegment kennen wir die Erwartungen dieser anspruchsvollen Käufergruppe und wissen, wie man exklusive Immobilien in Schneidhain, Fischbach und Mammolshain optimal in Szene setzt.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '1.200.000 €', sub: 'Einfamilienhaus Königstein' },
                  { label: 'Ø m²-Preis', value: '7.500 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '20 km', sub: 'A66 / B8' },
                  { label: 'Einwohner', value: '~16.000', sub: 'Stadt Königstein' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop" alt="Immobilien Königstein Hochtaunuskreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Königstein.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise im Luxussegment kombiniert mit professioneller Vermarktung – für den bestmöglichen Preis deiner Königsteiner Immobilie.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Königstein"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Königstein verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Königstein" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-left md:text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">deine Immobilie in Königstein. Unser Einsatz. Ihr Erfolg.</h2>
      ...
      <NearbyStaedte currentSlug="koenigstein" />
