...
export const metadata: Metadata = {
  title: 'Immobilienmakler Neu-Anspach – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Neu-Anspach & Hochtaunuskreis. Professioneller Immobilienverkauf mit marktgerechter Bewertung, persönlicher Betreuung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Neu-Anspach, Immobilien Neu-Anspach, Haus verkaufen Neu-Anspach, Wohnung verkaufen Neu-Anspach, Hochtaunuskreis Immobilien, Immobilienbewertung Neu-Anspach',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-neu-anspach' },
  openGraph: {
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Neu-Anspach',
    description: 'Wir kennen den Immobilienmarkt in Neu-Anspach und dem Hochtaunuskreis genau – Preise, Nachfrage und Besonderheiten vor Ort.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Neu-Anspach und dem gesamten Taunus-Raum.',
  },
  {
    icon: '📣',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Neu-Anspach und deine Ziele kennen.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir erstellen eine fundierte Marktpreisanalyse für Neu-Anspach und legen gemeinsam den optimalen Verkaufspreis fest.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerNeuAnspachPage() {
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Neu-Anspach</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-6">
                Immobilienmakler
                <span className="text-brand-green"> Neu-Anspach.</span>
              </h1>
              <p className="text-brand-gray-warm text-lg leading-relaxed mb-8">
                Dein Immobilienexperte für Neu-Anspach und den Hochtaunuskreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Neu-Anspach" className="w-full h-64 object-cover" style={{ objectPosition: 'center 15%' }} width={800} height={256} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Neu-Anspach</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„Neu-Anspach ist der ruhige Taunus zu einem fairen Preis – für Familien ein Traummarkt, für Verkäufer eine konstant gute Nachfrage."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Ruhige Einfamilienhauslagen und gut erschlossene Grundstücke sind am stärksten gefragt. Die Hochtaunus-Bahn verbindet Neu-Anspach mit Bad Homburg und Frankfurt – ein Argument, das bei Berufspendlern stark zieht.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Neu-Anspach
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Neu-Anspach – familienfreundlich<br />
                <span className="text-brand-green">im Herzen des Taunus.</span>
              </h2>
              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Neu-Anspach liegt im Hochtaunuskreis und überzeugt mit ruhiger Wohnlage, guter Infrastruktur und schneller Anbindung an Frankfurt und Bad Homburg. Die Stadt gilt als besonders familienfreundlich und zieht stetig neue Eigenheimkäufer an.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Nachfrage, die Preisunterschiede zwischen den Stadtteilen und aktuelle Markttrends – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '560.000 €', sub: 'Einfamilienhaus Neu-Anspach' },
                  { label: 'Ø m²-Preis', value: '3.600 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '30 km', sub: 'A5 / B456' },
                  { label: 'Einwohner', value: '~15.000', sub: 'Stadt Neu-Anspach' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop" alt="Immobilien Neu-Anspach Hochtaunuskreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
      ...
      <ProcessSteps steps={processSteps} title="In 4 Schritten zum Verkauf in Neu-Anspach" subtitle="Unkompliziert, transparent und vollständig in deinem eigenen Tempo." />
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">deine Immobilie in Neu-Anspach. Unser Einsatz. Ihr Erfolg.</h2>
      ...
      <NearbyStaedte currentSlug="neu-anspach" />
