...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Immobilienmakler Bad Homburg vor der Höhe – immovativInvest',
    description: 'Ihre Immobilie in Bad Homburg professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-bad-homburg',
  },
}
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Bad Homburg',
    description: 'Wir kennen den exklusiven Immobilienmarkt in Bad Homburg genau – von den Kaiserbädern bis nach Dornholzhausen, Gonzenheim und Ober-Erlenbach.',
  },
  {
    icon: '💎',
    title: 'Expertise im Premiumsegment',
    description: 'Bad Homburg zählt zu den teuersten Immobilienstandorten im Rhein-Main-Gebiet. Wir vermarkten exklusive Objekte mit dem nötigen Fingerspitzengefühl.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Bad Homburg – mit einem Ø m²-Preis von 5.800 € kennen wir jede Marktfacette.',
  },
  {
    icon: '⏱️',
  ...
  },
  {
    ...
    description: 'Grundbuchauszug, Energieausweis, Baupläne – wir kümmern uns um alle nötigen Dokumente für deinen reibungslosen Verkauf.',
  },
  {
    icon: '🔑',
    title: 'Vollständige Abwicklung',
    description: 'Von der Bewertung über den Kaufvertrag bis zur Schlüsselübergabe – wir übernehmen alles für dich.',
  },
]
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Bad Homburg kennen – ob Villa in Kirdorf, Altbau am Kurpark oder Neubau in Ober-Eschbach.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Bad Homburg und dem Hochtaunuskreis.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Exklusive Vermarktung',
    description: 'Professionelle Präsentation, gezielte Ansprache kaufkräftiger Interessenten aus dem Rhein-Main-Gebiet und qualifizierte Besichtigungen.',
  },
  {
    number: 4,
    icon: '🏆',
...
const stadtteilPreise = [
  ...
  { name: 'Dornholzhausen', preis: '5.500–7.500 €/m²', beschreibung: 'Ruhige Villenlage im Taunus' },
  { name: 'Gonzenheim', preis: '5.000–7.000 €/m²', beschreibung: 'Beliebte Wohnlage, gute Anbindung' },
  { name: 'Kirdorf', preis: '5.000–6.500 €/m²', beschreibung: 'Familienfreundlich, gute Schulen' },
  { name: 'Ober-Erlenbach', preis: '4.500–6.500 €/m²', beschreibung: 'Idyllische Lage am Taunusrand' },
  { name: 'Ober-Eschbach', preis: '4.500–6.000 €/m²', beschreibung: 'Ruhig, naturverbunden, Neubaugebiete' },
]

const niclasText = "Bad Homburg ist ein Premiummarkt – hier zählen neben dem Preis vor allem Präsentation und Diskretion. Hochwertige Fotos, ein anspruchsvolles Exposé und die gezielte Ansprache des richtigen Käuferprofils machen in diesem Segment den entscheidenden Unterschied."
...
export default function ImmobilienmaklerBadHomburgPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Bad Homburg" slug="bad-homburg" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Bad Homburg</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Bad Homburg.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Exklusive Kurstadt mit höchsten Immobilienpreisen im Rhein-Main-Gebiet.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Bad Homburg vor der Höhe und den Hochtaunuskreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Bad Homburg" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Bad Homburg</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mt-5">Bad Homburg ist eine der begehrtesten Wohnlagen im Rhein-Main-Gebiet – und das spüre ich bei jeder Besichtigung. Die Nachfrage kommt hier zu einem guten Teil aus dem Frankfurter Finanzsektor: Banker, Unternehmensberater, Expats, die gezielt in den Taunus ziehen wollen.</p>
                <p className="text-gray-600 text-sm leading-relaxed mt-3">Lagen wie Ober-Eschbach, Gonzenheim oder direkt am Kurpark erzielen andere Preise als der Schnitt. Ich kenne diese Unterschiede und nutze sie in deiner Vermarktung gezielt.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„In Bad Homburg habe ich schon Wohnungen verkauft, bei denen das erste Angebot am Tag der Besichtigung kam – der Markt hier ist schnell und kaufkräftig."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Bad Homburg profitiert von der direkten U-Bahn-Verbindung nach Frankfurt und dem Ruf als eine der sichersten und grünsten Städte der Region. Besonders gefragt: Einfamilienhäuser in ruhigen Wohnstraßen und großzügige Eigentumswohnungen in Kurparknähe.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Bad Homburg
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Bad Homburg – exklusive Kurstadt<br />
                <span className="text-brand-green">mit Spitzenpreisen im Taunus.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Bad Homburg vor der Höhe gehört zu den begehrtesten und teuersten Wohnstandorten in ganz Deutschland. Die historische Kurstadt mit Spielbank, Kaiserbädern und direkter A661-Anbindung nach Frankfurt (18 km) zieht kaufkräftige Käufer aus der gesamten Metropolregion an.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Preisunterschiede zwischen den Stadtteilen, die Erwartungen anspruchsvoller Käufer und die aktuellen Markttrends – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '850.000 €', sub: 'Einfamilienhaus Bad Homburg' },
                  { label: 'Ø m²-Preis', value: '5.800 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '18 km', sub: 'A661' },
                  { label: 'Einwohner', value: '~55.000', sub: 'Stadt Bad Homburg' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop" alt="Immobilien Bad Homburg Hochtaunuskreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-brand-anthrazit mb-3">
              Immobilienpreise nach <span className="text-brand-green">Stadtteil in Bad Homburg</span>
            </h2>
        ...
        <div className="container-max">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Bad Homburg.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Bad Homburg.
            </p>
          </div>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Bad Homburg"
          ...
          <div className="bg-brand-gray-light border-l-4 border-brand-green rounded-2xl p-8 max-w-3xl mx-auto">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <div className="text-xs text-brand-gray-warm">Dein Immobilienmakler in Bad Homburg</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Bad Homburg verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Bad Homburg" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 bg-brand-green">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">deine Immobilie in Bad Homburg. Unser Einsatz. Ihr Erfolg.</h2>
      ...
      {/* FAQ */}
      <section id="faq">
        <FAQ items={faqItems} title="Häufige Fragen – Immobilienmakler Bad Homburg" />
      </section>
      ...
      <NearbyStaedte currentSlug="bad-homburg" />
