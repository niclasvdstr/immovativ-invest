...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Immobilienmakler Bad Soden am Taunus – immovativInvest',
    description: 'Ihre Immobilie in Bad Soden professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-bad-soden',
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Bad Soden',
    description: 'Wir kennen den exklusiven Immobilienmarkt in Bad Soden genau – von Neuenhain bis Altenhain und den begehrten Villenlagen am Taunushang.',
  },
  {
    icon: '💎',
    title: 'Expertise im Premiumsegment',
    description: 'Bad Soden zählt zu den teuersten Wohnstandorten im Rhein-Main-Gebiet. Wir vermarkten exklusive Objekte mit dem nötigen Fingerspitzengefühl für anspruchsvolle Käufer.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Bad Soden – mit einem Ø m²-Preis von 6.800 € kennen wir jede Marktfacette.',
  },
  {
    icon: '⏱️',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Bad Soden kennen – ob Villa in Neuenhain, Altbau am Kurpark oder Neubau in Altenhain.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Bad Soden und dem Main-Taunus-Kreis.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerBadSodenPage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Bad Soden" slug="bad-soden" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Bad Soden</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Bad Soden.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Exklusive Kurstadt mit Villenlage am Taunushang.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Bad Soden am Taunus und den Main-Taunus-Kreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image
                  ...
                  alt="Niclas van der Straeten – Immobilienmakler Bad Soden"
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Bad Soden</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mt-5">Bad Soden am Taunus ist für mich eine der faszinierendsten Lagen im gesamten Rhein-Main-Gebiet. Hier trifft Waldlage auf kurze Frankfurt-Pendelzeiten – das schätzen vor allem jene Käufer, die bei der Lebensqualität keine Kompromisse machen.</p>
                <p className="text-gray-600 text-sm leading-relaxed mt-3">Die Kaufkraft in Bad Soden ist außergewöhnlich hoch. Objekte hier – vor allem Villen und großzügige Einfamilienhäuser – erzielen Preise, die nur wenige Lagen in Hessen schlagen. Ich kenne die spezifischen Straßen und Hanglagen, die besonders begehrt sind.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„Bad Soden ist eine der wenigen Lagen, wo ein gutes Objekt auch ohne Online-Inserat verkauft werden kann – das Netzwerk kaufkräftiger Interessenten ist so dicht."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Besonders gefragt sind Hanglagen mit Weitblick Richtung Frankfurt und parkähnliche Grundstücke. Die Nachfrage kommt zu einem großen Teil aus dem Bankensektor und von Unternehmerfamilien. Diskretion ist hier oft gewünscht – und mein Standard.</p>
          </div>
          </AnimateIn>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Bad Soden
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Bad Soden – Exklusive Kurstadt<br />
                <span className="text-brand-green">mit Villenlage am Taunushang.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Bad Soden am Taunus ist eine der exklusivsten Wohnadressen in ganz Deutschland. Die historische Kurstadt am Hang des Taunus mit ihren Mineralquellen, eleganten Villenvierteln und hervorragender S3-Anbindung nach Frankfurt zieht besonders vermögende Käufer an.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '950.000 €', sub: 'Einfamilienhaus Bad Soden' },
                  { label: 'Ø m²-Preis', value: '6.800 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '15 km', sub: 'A66 / S3' },
                  { label: 'Einwohner', value: '~22.000', sub: 'Stadt Bad Soden' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image
                ...
                alt="Immobilien Bad Soden am Taunus"
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Bad Soden.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Bad Soden.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Bad Soden"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Bad Soden verkaufen?
              </h2>
      ...
      <NearbyStaedte currentSlug="bad-soden" />
