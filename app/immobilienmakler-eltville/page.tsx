...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Eltville',
    description: 'Wir kennen den Immobilienmarkt in Eltville genau – von Erbach und Hattenheim über Kiedrich bis nach Martinsthal und Rauenthal im Rheingau.',
  },
  {
    icon: '🍷',
    title: 'Expertise in exklusiver Rheingaulage',
    description: 'Eltville am Rhein ist die Stadt des Weins und des Gutenbergmuseums. Die einzigartige Rheinlage und das Prestige des Rheingaus machen Immobilien hier besonders begehrt und wertstabil.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Eltville – mit einem Ø m²-Preis von 4.800 € kennen wir jede Marktfacette.',
  },
  {
    icon: '⏱️',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Eltville kennen – ob Weingut in Erbach, Villa in Kiedrich oder Einfamilienhaus in Rauenthal.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Eltville und dem Rheingau-Taunus-Kreis.',
  },
  {
    number: 3,
    icon: '🚀',
    title: 'Exklusive Vermarktung',
    description: 'Professionelle Präsentation, gezielte Ansprache kaufkräftiger Interessenten aus Frankfurt, Wiesbaden und dem Rhein-Main-Gebiet sowie qualifizierte Besichtigungen.',
  },
  {
    number: 4,
    icon: '🏆',
...
export default function ImmobilienmaklerEltvillePage() {
  return (
    <main className="min-h-screen bg-white">
      <CityJsonLd cityName="Eltville am Rhein" slug="eltville" />
      <Header
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Eltville</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Eltville.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Exklusive Weinstadt im Rheingau mit einzigartiger Lage am Rhein.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Eltville am Rhein und den Rheingau-Taunus-Kreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image
                  ...
                  alt="Niclas van der Straeten – Immobilienmakler Eltville"
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Eltville</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
                <p className="text-gray-600 text-sm leading-relaxed mb-3">Eltville am Rhein ist eine Lage, die für sich selbst spricht: Weinberge, Rheinufer, historische Weingüter, Wiesbaden in 15 Minuten. Immobilien hier sind keine normale Ware – sie sind Lebensqualität in Stein.</p>
                <p className="text-gray-600 text-sm leading-relaxed mb-5">Der Käuferkreis für Eltville-Objekte ist anders als in anderen Städten: Wohlhabende Käufer aus dem Rhein-Main-Gebiet, manchmal aus dem gesamten deutschsprachigen Raum, die Weinregion als Wohnort suchen. Ich vermarkte das entsprechend – mit der richtigen Geschichte.</p>
      ...
      <section className="py-12 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-brand-anthrazit rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-4">„Eltville verkauft man nicht mit Quadratmetern – man verkauft es mit dem Lebensgefühl. Das macht die Vermarktung hier besonders, und besonders wirkungsvoll."</p>
            <p className="text-gray-400 text-sm leading-relaxed">Rheinnah gelegene Objekte und Häuser in den Weinbergslagen oberhalb der Stadt erzielen die höchsten Preise. Auch sanierte Fachwerk-Altbauten in der historischen Altstadt sind sehr begehrt. Die Nachfrage übersteigt das Angebot regelmäßig.</p>
          </div>
          </AnimateIn>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green-50 border border-brand-green-100 text-brand-green rounded-full px-4 py-2 text-sm font-semibold mb-6">
                ...
                Immobilienmarkt Eltville
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Eltville – Exklusive Weinstadt<br />
                <span className="text-brand-green">mit einzigartiger Lage am Rhein.</span>
              </h2>

              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Eltville am Rhein ist die Weinhauptstadt des Rheingaus und gleichzeitig die größte Stadt im Rheingau-Taunus-Kreis. Berühmt für den Rosenmarkt, das Gutenberg-Museum und weltbekannte Weingüter, liegt Eltville in einer der schönsten Kulturlandschaften Deutschlands – direkt am Rhein.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Besonderheiten des Eltviller Marktes, die Erwartungen anspruchsvoller Käufer aus dem Rhein-Main-Gebiet und die aktuellen Preisentwicklungen – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '650.000 €', sub: 'Einfamilienhaus Eltville' },
                  { label: 'Ø m²-Preis', value: '4.800 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '35 km', sub: 'A66 / A671' },
                  { label: 'Einwohner', value: '~17.000', sub: 'Stadt Eltville' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image
                ...
                alt="Immobilien Eltville am Rhein Rheingau"
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Eltville"
      ...
      <NearbyStaedte currentSlug="eltville" />
