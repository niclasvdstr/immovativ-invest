...
export const metadata: Metadata = {
  title: 'Immobilienmakler Maintal – Immobilie verkaufen | immovativInvest',
  description: 'Immobilienmakler in Maintal im Main-Kinzig-Kreis. Professioneller Verkauf von Immobilien direkt an der Frankfurter Stadtgrenze – marktgerechte Bewertung, persönliche Betreuung & nur 6 Wochen Vertragslaufzeit. Kostenlose Erstberatung!',
  keywords: 'Immobilienmakler Maintal, Immobilien Maintal, Haus verkaufen Maintal, Wohnung verkaufen Maintal, Main-Kinzig-Kreis Immobilien, Immobilienbewertung Maintal, Dörnigheim Bischofsheim Hochstadt Wachenbuchen Immobilien',
  alternates: { canonical: 'https://www.immovativ-invest.de/immobilienmakler-maintal' },
  openGraph: {
    title: 'Immobilienmakler Maintal – immovativInvest',
    description: 'Ihre Immobilie in Maintal professionell vermarkten. Kostenlose Bewertung, nur 6 Wochen Vertragslaufzeit, 4,9★ Bewertung.',
    type: 'website',
    url: 'https://www.immovativ-invest.de/immobilienmakler-maintal',
...
const benefits = [
  {
    icon: '📍',
    title: 'Lokale Marktkenntnis Maintal',
    description: 'Wir kennen den Immobilienmarkt in Maintal genau – von Dörnigheim und Bischofsheim bis nach Hochstadt und Wachenbuchen.',
  },
  {
    icon: '💡',
    title: 'Günstige Alternative zu Frankfurt',
    description: 'Maintal bietet Immobilien direkt an der Frankfurter Stadtgrenze zu deutlich günstigeren Preisen – ideal für Käufer, die Frankfurter Infrastruktur ohne Frankfurter Preise suchen.',
  },
  {
    icon: '📊',
    title: 'Marktgerechte Bewertung',
    description: 'Fundierte Wertermittlung auf Basis aktueller Marktdaten aus Maintal – mit einem Ø m²-Preis von 3.400 € kennen wir jede Marktfacette.',
  },
  {
    icon: '⏱️',
...
const processSteps = [
  {
    ...
    description: 'In einem persönlichen Gespräch lernen wir deine Immobilie in Maintal kennen – ob Einfamilienhaus in Dörnigheim, Reihenhaus in Bischofsheim oder Wohnung in Hochstadt.',
  },
  {
    number: 2,
    icon: '📋',
    title: 'Immobilienbewertung',
    description: 'Wir ermitteln den marktgerechten Wert deiner Immobilie auf Basis aktueller Vergleichsdaten aus Maintal und dem Main-Kinzig-Kreis.',
  },
  {
    number: 3,
    icon: '🚀',
...
export default function ImmobilienmaklerMaintaPage() {
  return (
    <>
    <CityJsonLd cityName="Maintal" slug="maintal" />
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-brand-gray-warm mb-4">
                ...
                <span>›</span>
                <span className="text-brand-anthrazit font-medium">Maintal</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-anthrazit leading-tight mb-4">
                Immobilienmakler
                <span className="text-brand-green"> Maintal.</span>
              </h1>

              <p className="text-brand-gray-warm text-lg leading-relaxed mb-3 font-medium">
                Günstige Alternative direkt an der Frankfurter Stadtgrenze.
              </p>

              <p className="text-brand-gray-warm text-base leading-relaxed mb-8">
                Dein Immobilienexperte für Maintal und den Main-Kinzig-Kreis. Wir vermarkten deine Immobilie professionell und erzielen den bestmöglichen Preis – mit persönlicher Betreuung von Anfang bis Ende.
              </p>

              <ul className="space-y-5 mb-10">
                {[
                  'Lokale Expertise im Main-Kinzig-Kreis',
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-large border border-brand-gray-border">
              <div className="relative">
                <Image src="/hero-niclas-2.png" alt="Niclas van der Straeten – Immobilienmakler Maintal" className="w-full h-64 object-cover" width={800} height={256} style={{ objectPosition: 'center 15%' }} priority />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-anthrazit/80 to-transparent px-5 py-4 flex justify-end">
                  <div className="text-right">
                    ...
                    <div className="text-gray-300 text-xs">Dein Ansprechpartner in Maintal</div>
                  </div>
                </div>
              </div>
              <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Maintal – Günstige Alternative<br />
              ...
              <p className="text-brand-gray-warm leading-relaxed mb-5">
                Maintal im Main-Kinzig-Kreis grenzt direkt an Frankfurt und Hanau. Die rund 38.000 Einwohner schätzen die günstigeren Immobilienpreise bei gleichzeitig hervorragender Anbindung: Die S8 bringt Pendler in wenigen Minuten nach Frankfurt, die A66 ist direkt erreichbar.
              </p>
              <p className="text-brand-gray-warm leading-relaxed mb-8">
                Als lokaler Immobilienmakler kennen wir die Unterschiede zwischen den vier Stadtteilen, die Erwartungen von Familien und Pendlern und die aktuellen Preisentwicklungen – und nutzen dieses Wissen gezielt für deinen Verkaufserfolg.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Ø Hauspreis', value: '440.000 €', sub: 'Einfamilienhaus Maintal' },
                  { label: 'Ø m²-Preis', value: '3.400 €', sub: 'Eigentumswohnung' },
                  { label: 'Entfernung Frankfurt', value: '12 km', sub: 'A66 / S8' },
                  { label: 'Einwohner', value: '~38.000', sub: 'Stadt Maintal' },
                ].map(stat => (
            ...
            <div className="relative">
              <Image src="https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=800&h=600&fit=crop" alt="Immobilien Maintal Main-Kinzig-Kreis" className="w-full h-auto rounded-3xl shadow-large object-cover" width={800} height={600} />
        ...
        <div className="container-max">
          ...
          <div className="text-left md:text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-4">
              <span className="text-brand-green">Deine Vorteile</span> mit immovativ<span className="font-black">Invest</span> in Maintal.
            </h2>
            <p className="text-brand-gray-warm text-lg max-w-2xl mx-auto">
              Lokale Expertise kombiniert mit professioneller Vermarktung – für den bestmöglichen Verkaufspreis deiner Immobilie in Maintal.
            </p>
          </div>
          </AnimateIn>
      ...
      <ProcessSteps
        steps={processSteps}
        title="In 4 Schritten zum Verkauf in Maintal"
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-anthrazit mb-6 leading-tight">
                Du möchtest deine Immobilie<br />in Maintal verkaufen?
              </h2>
            ...
            <div className="relative">
              <Image src="/niclas-hochhaus.png" alt="Niclas van der Straeten – Immobilienmakler Maintal" className="w-full h-[480px] object-cover rounded-3xl shadow-large" width={800} height={480} style={{ objectPosition: 'center 20%' }} />
            </div>
          </div>
        </div>
      </section>
  ...
  Immobilienbewertung starten →
      ...
      <NearbyStaedte currentSlug="maintal" />
