...
export default function ImmobilienmaklerMaintaPage() {
  return (
    ...
    <main className="min-h-screen bg-white">
      ...
      {/* CTA Banner */}
      <section className="py-16 px-4 md:px-8 bg-brand-green"><div className="max-w-3xl mx-auto text-left md:text-center"><h2 className="text-2xl md:text-3xl font-bold text-white mb-4">deine Immobilie in Maintal. Unser Einsatz. Ihr Erfolg.</h2><p className="text-green-100 mb-6">Kostenlose Erstberatung und Bewertung – ganz ohne Verpflichtung.</p><CTAButton href="/verkaufen" variant="secondary" size="lg">
