      ...
      <div className="container-max">
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-3 bg-white border border-brand-gray-border rounded-2xl px-5 py-3 shadow-soft">
            ...
            <span className="font-semibold text-brand-anthrazit text-sm">4,9</span>
            <span className="text-brand-gray-warm text-sm">· 100+ Google-Bewertungen</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {items.map((t) => (
            <div key={t.name} className="bg-white rounded-2xl p-6 shadow-soft border border-brand-gray-border hover:shadow-medium transition-shadow duration-300 flex flex-col">
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-brand-anthrazit text-sm">{t.name}</div>
                    <div className="text-xs text-brand-gray-warm">{t.timeAgo}</div>
                  </div>
                </div>
                <GoogleIcon />
              </div>
              ...
              {/* Text */}
              <p className="mt-3 text-brand-gray-warm leading-relaxed text-sm flex-1">
                {t.text}
              </p>

              {/* Footer */}
              <div className="mt-4 pt-3 border-t border-brand-gray-border">
                <span className="text-xs text-brand-gray-warm">{t.propertyType} · {t.location}</span>
              </div>
            </div>
          ))}
        </div>
